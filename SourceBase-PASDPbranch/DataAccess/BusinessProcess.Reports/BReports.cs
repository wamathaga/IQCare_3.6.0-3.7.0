        ...
        public DataSet IQTouchGetPatientVisitSummary(int PatientId)
        {
            lock (this)
            {
                try
                {
                    ...
                    return (DataSet)ReportManager.ReturnObject(ClsUtility.theParams, "sp_PASDP_PatientVisitSummaryReport", ClsUtility.ObjectEnum.DataSet);
                }
                catch
                {
                    throw;
        ...
        public DataSet IQTouchGetPatientSummary(int PatientId)
        {
            lock (this)
            {
                try
                {
                    ...
                    ClsUtility.AddParameters("@ptn_pk", SqlDbType.Int, PatientId.ToString());
                    return (DataSet)ReportManager.ReturnObject(ClsUtility.theParams, "sp_PASDP_PaediatricPatientSummary", ClsUtility.ObjectEnum.DataSet);
                }
                catch
                {
                    throw;
