...
namespace BusinessProcess.Administration
{
    public class BDesignation : ProcessBase, IDesignation
    {
        ...
        public int SaveNewDesignation(string DesignationName, int UserID,  int Sequence, int DisplayMode)
        {
            try
            {
        ...
        public int UpdateDesignation(int DesignationID, string DesignationName, int UserID, int DeleteFlag, int Sequence, int check, int DisplayMode)
        {
            try
            {
                this.Connection = DataMgr.GetConnection();
