    ...
    public class BAppointment : ProcessBase, IAppointment
    {
        ...
        public DataTable CheckAppointmentExistance(int PatientId, int LocationId, String AppDate,int ReasonId,int visitId)
        {
            lock (this)
            {
                try
                {
                    ...
                    theDt = (DataTable)SaveAppointment.ReturnObject(ClsUtility.theParams, "pr_Scheduler_CheckAppointmentExistance_Constella", ClsUtility.ObjectEnum.DataTable);
        ...
        public DataSet GetAppointmentGrid(int AppStatus, DateTime FromDate, DateTime ToDate, int LocationID)
        {
            lock (this)
            {
                ...
                return (DataSet)AppointmentManager.ReturnObject(ClsUtility.theParams, "pr_Scheduler_AppointmentList_Constella", ClsUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetPatientppointmentDetails(int PatientId, int LocationId, int VisitId)
        {
            lock (this)
            {
                try
                {
                    ...
                    ClsUtility.AddParameters("@VisitId", SqlDbType.Int, VisitId.ToString());
                    ClsUtility.AddParameters("@password", SqlDbType.VarChar, ApplicationAccess.DBSecurity);
                    return (DataSet)SaveAppointment.ReturnObject(ClsUtility.theParams, "pr_Scheduler_GetPatientAppointmentDetails_Constella", ClsUtility.ObjectEnum.DataSet);
...
//*****************************************************************************************//
        ...
        // return (DataSet)SearchResultAppointStatus.ReturnObject(ClsUtility.theParams, "pr_Scheduler_Search_PatientAppointment_Constella", ClsUtility.ObjectEnum.DataSet);
        //     }
