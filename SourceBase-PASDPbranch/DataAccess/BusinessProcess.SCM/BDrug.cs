    ...
    public class BDrug:ProcessBase,IDrug
    {
            ...
            Int32 theOrderType, Int32 theProgramId, string theRegimen, Int32 theOrderId, DataTable theDT, DateTime PharmacyRefillDate)
        {
            ...
            try
            {
                ...
                thePharmacyDT = (DataTable)theManager.ReturnObject(ClsUtility.theParams, "pr_SCM_SavePharmacyDispenseOrder_Futures", ClsUtility.ObjectEnum.DataTable);
                ...
                foreach (DataRow theDR in theDT.Rows)
                {
                    ...
                    Int32 theRowCount = (Int32)theManager.ReturnObject(ClsUtility.theParams, "pr_SCM_SavePharmacyDispenseOrderDetail_Futures", ClsUtility.ObjectEnum.ExecuteNonQuery);
            ...
            try
            {
                ...
                foreach (DataRow theDR in theDT.Rows)
                {
                    if (Convert.ToInt32(theDR["ReturnQty"]) > 0)
                    {
                        ...
                        ClsUtility.AddParameters("@LocationId", SqlDbType.Int, theLocationId.ToString());
                        ClsUtility.AddParameters("@UserId", SqlDbType.Int, theUserId.ToString());
                        Int32 theRowCount = (Int32)theManager.ReturnObject(ClsUtility.theParams, "pr_SCM_SavePharmacyReturnDetail_Futures", ClsUtility.ObjectEnum.ExecuteNonQuery);
                    }
                }
                DataMgr.CommitTransaction(this.Transaction);
                DataMgr.ReleaseConnection(this.Connection);
        ...
        public DataTable GetPersonDispensingDrugs(string UserName)
        {
            lock (this)
            {
                ...
                ClsObject theManager = new ClsObject();
                return (DataTable)theManager.ReturnObject(ClsUtility.theParams, "Pr_SCM_GetPersonDispensingDrugs", ClsUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public DataTable CheckPaperlessClinic(int LocationID)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@LocationID", SqlDbType.Int, LocationID.ToString());
                ClsObject theManager = new ClsObject();
                return (DataTable)theManager.ReturnObject(ClsUtility.theParams, "Pr_SCM_CheckPaperlessClinic", ClsUtility.ObjectEnum.DataTable);
            }
        }
