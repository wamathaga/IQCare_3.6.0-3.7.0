...
namespace BusinessProcess.Security
{
    public class BIQCareSystem : ProcessBase,IIQCareSystem
    {
        ...
        public DataSet GetMySQLAuditTrailData()
        {
            ...
            ClsUtility.Init_Hashtable();
            return (DataSet)MySQLManager.ReturnMySQLObject(ClsUtility.theParams, "GetAuditTrails", ClsUtility.ObjectEnum.DataSet);
        }
        ...
        public DataSet GetVisitForms()
        {
            ...
            ClsUtility.Init_Hashtable();
            return (DataSet)VisitManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectVisitType", ClsUtility.ObjectEnum.DataSet);
        }
