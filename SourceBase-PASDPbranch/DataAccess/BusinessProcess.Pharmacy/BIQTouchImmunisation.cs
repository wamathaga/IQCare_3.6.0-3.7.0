    ...
    public class BIQTouchImmunisation : ProcessBase, IBIQTouchImmunisation
    {
        ...
        public int SaveUpdateImmunisationDetail(List<BIQTouchmmunisationFields> immnisationFields)
        {
            ...
            try
            {
                ...
                foreach (var Value in immnisationFields)
                {
                    ...
                    theRowAffected = (int)immunisation.ReturnObject(ClsUtility.theParams, "Pr_IQTouch_Pharmacy_AddUpdateImmunisation", ClsUtility.ObjectEnum.ExecuteNonQuery);
                    if (theRowAffected == 0)
                    {
        ...
        public DataSet GetImmunisationDetails(BIQTouchmmunisationFields immnisationFields)
        {
            lock (this)
            {
                ...
                return (DataSet)ImmunisationManager.ReturnObject(ClsUtility.theParams, "Pr_IQTouch_Pharmacy_GetImmunisationDetails", ClsUtility.ObjectEnum.DataSet);
            }
