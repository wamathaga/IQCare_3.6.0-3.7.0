...
namespace BusinessProcess.Pharmacy
{
    public class BDrug : ProcessBase, IDrug
    {
        ...
        public DataSet GetDrugInstructions(Int32 DrugId)
        {
            ...
            return (DataSet)theManager.ReturnObject(ClsUtility.theParams, "pr_SCM_GetDrugInstructions", ClsUtility.ObjectEnum.DataSet);
        }
        ...
        public DataSet GetDrugInstructionsExistingOrder(Int32 DrugId, int PharmacyId)
        {
            ...
            ClsUtility.AddParameters("@PharmacyID", SqlDbType.Int, PharmacyId.ToString());
            ClsObject theManager = new ClsObject();
            return (DataSet)theManager.ReturnObject(ClsUtility.theParams, "pr_SCM_GetDrugInstructions_ExistingOrder", ClsUtility.ObjectEnum.DataSet);
        }
