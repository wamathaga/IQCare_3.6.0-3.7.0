    ...
    public class BKNHRevisedAdult : ProcessBase, IKNHRevisedAdult
    {
         public DataTable GetDropdownFieldDetails(int featureId)
         {
             lock (this)
             {
                 ...
                 return (DataTable)PatientHistory.ReturnObject(ClsUtility.theParams, "pr_KNH_Getdropdownfieldlist", ClsUtility.ObjectEnum.DataTable);
             }
         }
         public DataSet SaveUpdateKNHRevisedAdultFollowupData(Hashtable hashTable, DataTable dtMultiSelectValues,int signature,int UserId)
         {
             try
             {
                ...
                ClsUtility.AddParameters("@OtherMedicalConditionNotes", SqlDbType.VarChar, hashTable["OtherMedicalConditionNotes"].ToString());
                 ...
                 // DataSet tempDataSet;
                 theDS = (DataSet)VisitManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_KNH_RevisedFollowup_FORM", ClsUtility.ObjectEnum.DataSet);
         ...
         public DataSet GetKNHRevisedAdultDetails(int ptn_pk, int visitpk)
         {
             lock (this)
             {
                 ...
                 return (DataSet)BusinessRule.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_RevisedAdult_Data", ClsUtility.ObjectEnum.DataSet);
             }
         }
         public DataSet SaveUpdateKNHRevisedFollowupData_TriageTab(Hashtable hashTable, DataTable dtMultiSelectValues, int DataQuality, int signature, int UserId)
         {
             try
             {
                 ...
                 // DataSet tempDataSet;
                 theDS = (DataSet)VisitManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_KNH_RevisedFollowup_FORM_Triage", ClsUtility.ObjectEnum.DataSet);
                 visitID = (int)theDS.Tables[0].Rows[0]["Visit_Id"];
         ...
         public DataSet SaveUpdateKNHRevisedFollowupData_CATab(Hashtable hashTable, DataTable dtMultiSelectValues, int DataQuality, int signature, int UserId)
         {
             try
             {
                 ...
                 // DataSet tempDataSet;
                 theDS = (DataSet)VisitManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_KNH_RevisedFollowup_FORM_CATab", ClsUtility.ObjectEnum.DataSet);
                 visitID = (int)theDS.Tables[0].Rows[0]["Visit_Id"];
         ...
         public DataSet SaveUpdateKNHRevisedFollowupData_ExamTab(Hashtable hashTable, DataTable dtMultiSelectValues, int DataQuality, int signature, int UserId)
         {
             try
             {
                 ...
                 // DataSet tempDataSet;
                 theDS = (DataSet)VisitManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_KNH_RevisedFollowup_FORM_ExamTab", ClsUtility.ObjectEnum.DataSet);
                 visitID = (int)theDS.Tables[0].Rows[0]["Visit_Id"];
         ...
         public DataSet SaveUpdateKNHRevisedFollowupData_MgtTab(Hashtable hashTable, DataTable dtMultiSelectValues, int DataQuality, int signature, int UserId)
         {
             try
             {
                 ...
                 // DataSet tempDataSet;
                 theDS = (DataSet)VisitManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_KNH_RevisedFollowup_FORM_MgtTab", ClsUtility.ObjectEnum.DataSet);
                 visitID = (int)theDS.Tables[0].Rows[0]["Visit_Id"];
