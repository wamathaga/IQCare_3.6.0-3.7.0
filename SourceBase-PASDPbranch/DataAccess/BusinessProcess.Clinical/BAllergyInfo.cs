    ...
    public class BAllergyInfo : ProcessBase, IAllergyInfo
    {
        ...
        public int SaveAllergyInfo(int Id, int Ptn_Pk, string AllergyType, string Allergen, string otherAllergen, string severity, string typeReaction, int UserId, int DeleteFlag, string dataAllergy)
        {
            ...
            try
            {
                ...
                //}
                retval = (int)FamilyInfo.ReturnObject(ClsUtility.theParams, "Pr_Clinical_SaveAllergyInfo", ClsUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public DataSet GetAllAllergyData(int PatientId)
        {
            lock (this)
            {
                ...
                ClsObject FamilyInfo = new ClsObject();
                return (DataSet)FamilyInfo.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetAllAllergyData", ClsUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public int DeleteAllergyInfo(int Id, int @UserId)
        {
            try
            {
                ...
                theAffectedRows = (int)DeleteFamilyInfo.ReturnObject(ClsUtility.theParams, "Pr_Clinical_DeleteAllergyInfo", ClsUtility.ObjectEnum.ExecuteNonQuery);
