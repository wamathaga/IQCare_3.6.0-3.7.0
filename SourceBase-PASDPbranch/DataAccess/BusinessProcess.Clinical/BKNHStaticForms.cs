    ...
    public class BKNHStaticForms : ProcessBase, IKNHStaticForms
    {
        public DataSet GetExistKNHStaticFormbydate(int PatientID, string VisitdByDate, int locationID,int Visittype)
        {
            lock (this)
            {
                ...
                return (DataSet)VisitManager.ReturnObject(ClsUtility.theParams, "pr_GetExistingVisitingDate", ClsUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet SaveUpdateExpressFormTriageTab(Hashtable theHT, DataTable dt, DataTable referredTo)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_KNH_Express_Form_TriageTab", ClsUtility.ObjectEnum.DataSet);
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        int save = (int)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_MultiSelect", ClsUtility.ObjectEnum.ExecuteNonQuery);
                        //updateFlag = 0;
                    }
                }
        ...
        public DataSet GetExpressFormData(int ptn_pk, int visit_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_Express_Form_data", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetExpressFormAutoPopulatingData(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_Express_Form_Autopopulating_data", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetPEPFormAutoPopulatingData(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_PEP_Form_Autopopulating_data", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetTBScreeningAutoPopulatingData(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_TBScreening_Autopopulating_data", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetPwPAutoPopulatingData(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_PwP_Autopopulating_data", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet CheckIfPreviuosTabSaved(string tabName, int visit_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_CheckIfPreviousTabIsSaved", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetTabID(string tabName)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetTabID", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet CheckIfTabSaved(int tabID, int visit_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_CheckIfTabSaved", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetExtruderData(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_ExtruderVitals", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetLatestWHOStage(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_WHOStage", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetTBScreeningFormData(int ptn_pk, int visit_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_TBScreening_UserControl", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetPwPFormData(int ptn_pk, int visit_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_PwP_UserControl", ClsUtility.ObjectEnum.DataSet);
        ...
        public string GetSignature(string tabName, int visit_pk)
        {
            ...
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_Get_KNH_Signature", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet SaveUpdateARVTherapy(Hashtable theHT)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_ARVTherapy", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetLastRegimenDispensed(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetLastRegimensDispensed", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetPatientDrugHistory(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetPatientDrugHistory", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet useExpressFormRules(int ptn_pk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_UseExpressFormRules", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet checkDuplicateVisit(string visitDate, int visitType, int ptnPk)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_CheckDuplicateVisit", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet SaveUpdateExpressFormClinicalAssessmentTab(Hashtable theHT, DataTable ARVShortTermEffects, DataTable ARVLongTermEffects, DataTable Eligiblethrough, DataTable ARTchangecode, DataTable ARTstopcode)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_KNH_Express_Form_CATab", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataSet SaveUpdateTBScreening(Hashtable theHT, DataTable TBAssessment, DataTable IPTStopReason, DataTable ReviewCheckList, DataTable SignsOfHepatitis)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_TBScreening_UserControl", ClsUtility.ObjectEnum.DataSet);
                //TB Assessment
                if (TBAssessment.Rows.Count > 0)
                {
                    for (int i = 0; i < TBAssessment.Rows.Count; i++)
                    {
                        ...
                        int TBAssess = (int)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_TBAssessment", ClsUtility.ObjectEnum.ExecuteNonQuery);
                    }
                }
                ...
                if (IPTStopReason.Rows.Count > 0)
                {
                    for (int i = 0; i < IPTStopReason.Rows.Count; i++)
                    {
                        ...
                        ClsUtility.AddParameters("@UserId", SqlDbType.Int, theHT["userID"].ToString());
                        int IPTStop = (int)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_IPTStopReason", ClsUtility.ObjectEnum.ExecuteNonQuery);
                    }
                }
                ...
                if (ReviewCheckList.Rows.Count > 0)
                {
                    for (int i = 0; i < ReviewCheckList.Rows.Count; i++)
                    {
                        ...
                        ClsUtility.AddParameters("@UserId", SqlDbType.Int, theHT["userID"].ToString());
                        int IPTStop = (int)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_TBReviewCheckList", ClsUtility.ObjectEnum.ExecuteNonQuery);
                    }
                }
                ...
                if (SignsOfHepatitis.Rows.Count > 0)
                {
                    for (int i = 0; i < SignsOfHepatitis.Rows.Count; i++)
                    {
                        ...
                        int SignsHepatitis = (int)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_MultiSelect", ClsUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public DataSet SaveUpdatePwP(Hashtable theHT, DataTable HighRisk, DataTable TransitionPreparation, DataTable ReferredTo, DataTable Counselling)
        {
            lock (this)
            {
                ...
                theDS = (DataSet)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveUpdate_PwP_UserControl", ClsUtility.ObjectEnum.DataSet);
        ...
        public DataTable GetPatientFeatures(int Ptn_pk)
        {
            ...
            ClsUtility.Init_Hashtable();
            ClsUtility.AddParameters("@Ptn_pk", SqlDbType.Int, Ptn_pk.ToString());
            DataTable dtfeatures = (DataTable)ClsObj.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPatientFeatures", ClsUtility.ObjectEnum.DataTable);
            return dtfeatures;
