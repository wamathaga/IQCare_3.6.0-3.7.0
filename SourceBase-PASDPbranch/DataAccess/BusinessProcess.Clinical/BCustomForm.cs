    ...
    public class BCustomForm : ProcessBase, ICustomForm
    {
        ...
        public DataSet GetFieldName_and_LabelPharmacy(int FeatureId, int PatientId)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@password", SqlDbType.VarChar, ApplicationAccess.DBSecurity);
                ClsObject FieldMgr = new ClsObject();
                return (DataSet)FieldMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPatientPharmacyCustomFormFieldLabel_Constella", ClsUtility.ObjectEnum.DataSet);
            }
        }
        #endregion
        ...
        public int GetCustomFormSavedByUser(int FeatureId, int TabID)
        {
            lock (this)
            {
                ...
                DataTable dtTmp = (DataTable)FieldMgr.ReturnObject(ClsUtility.theParams, "pr_CustomFormSavedByUser", ClsUtility.ObjectEnum.DataTable);
