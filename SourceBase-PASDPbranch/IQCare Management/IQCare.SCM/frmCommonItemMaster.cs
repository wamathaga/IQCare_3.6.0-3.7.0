    ...
    public partial class frmCommonItemMaster : Form
    {
        ...
        private void ShowGrid(DataTable theDT)
        {
            try
            {
                ...
                PriorityId.DataPropertyName = "SRNO";
                ColName.DataPropertyName = "Name";
                ColStatus.DataPropertyName = "Status";
                ColUpdate.DataPropertyName = "updateflag";
                Id.Visible = false;
                ...
                else
                {
                    if (ItemName.ToUpper() != txtItemName.Text.ToUpper() && Status != ddlStatus.SelectedItem.ToString())
                    {
                        ...
                        foreach (DataRow theDR in DTItemlistnew.Rows)
                        {
                            ...
                            if (txtItemName.Text.ToUpper().Replace(" ","") == Convert.ToString(theDR["Name"]).ToUpper().Replace(" ","") && ddlStatus.SelectedItem.ToString() == Convert.ToString(theDR["Status"]))
                            {
