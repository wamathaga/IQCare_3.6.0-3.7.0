...
namespace IQCare.FormBuilder
{
    public class clsCommon
    {
        ...
        public static void CreateGridColumnsForFormBuilder(DataGridView dgwDataGrid, DataSet dsBindColumns)
        {
            ...
            dgwDataGrid.Columns.AddRange(ddlDgwFieldsName, txtFieldLabel, new DataGridViewTextBoxColumn(), new DataGridViewImageColumn(), new DataGridViewImageColumn(), new DataGridViewTextBoxColumn(), new DataGridViewTextBoxColumn(), new DataGridViewTextBoxColumn(), new DataGridViewTextBoxColumn());
        ...
        public static DataTable CreateMstVersionTable()
        {
            ...
            dtDataColumn = new DataColumn();
            dtDataColumn.DataType = Type.GetType("System.DateTime");
