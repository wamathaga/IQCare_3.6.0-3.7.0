        ...
        private void Init_Form()
         {
            ...
            DataTable theExitReason = new DataTable();
            //Jayant-12/06/2104 Exit Reason for PASDP
            if (dsCareEndedInfo.Tables[5].Rows.Count > 0)
            {
                if (Convert.ToInt32(dsCareEndedInfo.Tables[5].Rows[0]["ModuleId"]) == 205)
                {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int iSave = objCareEnd.SaveCareEndDetails(dsCareEndDetail, GblIQCare.iCareEndedId,"CareEnd_"+cmbTechnicalArea.Text.ToString().Trim(), txtSection.Text,
                   Convert.ToInt32(cmbTechnicalArea.SelectedValue), GblIQCare.AppUserId, GblIQCare.AppCountryId, ID, GblIQCare.dtConditionalFields, theDeathReason, GblIQCare.AppLocationId);
                GblIQCare.dtConditionalFields.Clear();
