...
using Application.Presentation;
    ...
    public partial class frmBusinessRule : Form
    {
        ...
        private void frmBusinessRule_Load(object sender, EventArgs e)
        {
            ...
            if (GblIQCare.strICD10 == "ICD10")
            {
                GblIQCare.blnOtherICD10 = false;
                GblIQCare.blnICD10multiselect = false;
                lnklabel1.Visible = true;
                lnklabel2.Visible = true;
            ...
            else
            {
                ...
                lnklabel1.Visible = false;
                lnklabel2.Visible = false;
            }
            //set css begin
        ...
        {
            Boolean blnmaxvalue=false;
            Boolean blnminvalue=false;
            Boolean blnmaxnormalvalue=false;
            Boolean blnminnormalvalue=false;
            foreach (var item in chkLstBox.CheckedItems)
            {
                string stritem = chkLstBox.GetItemText(item);
                if (stritem == "Max Value")
                {
                    blnmaxvalue = true;
                }
                if (stritem == "Min Value")
                {
                    blnminvalue = true;
                }
                if (stritem == "Max Normal")
                {
                    blnmaxnormalvalue = true;
                }
                if (stritem == "Min Normal")
                {
                    blnminnormalvalue = true;
                }
            }
            if (GblIQCare.iManageCareEnded == 1)
            {
            ...
            else 
            {
                ...
                if ((GblIQCare.strDisplayType.ToString() == "Numeric" || GblIQCare.strDisplayType.ToString() == "DecimalTextBox") && (dsBusinessRule.Tables[0].Rows[1]["Id"].ToString() == "2") && (blnmaxvalue))
                {
                    if (txtMaxVal.Text.ToString() == null || txtMaxVal.Text.ToString() == "")
                    {
                        IQCareWindowMsgBox.ShowWindow("EnterValue", this);
                ...
                if ((GblIQCare.strDisplayType.ToString() == "Numeric" || GblIQCare.strDisplayType.ToString() == "DecimalTextBox") && (dsBusinessRule.Tables[0].Rows[2]["Id"].ToString() == "3") && (blnminvalue))
                {
                    if (txtMinVal.Text.ToString() == null || txtMinVal.Text.ToString() == "")
                    {
                        IQCareWindowMsgBox.ShowWindow("EnterValue", this);
                ...
                if ((GblIQCare.strDisplayType.ToString() == "Numeric" || GblIQCare.strDisplayType.ToString() == "DecimalTextBox") && (blnmaxvalue) && (blnminvalue))
                {
                    if (Convert.ToDecimal(txtMinVal.Text) >= Convert.ToDecimal(txtMaxVal.Text))
                    {
                        IQCareWindowMsgBox.ShowWindow("EnterCorrectValue", this);
                ...
                // For Max Normal
                if ((GblIQCare.strDisplayType.ToString() == "Numeric" || GblIQCare.strDisplayType.ToString() == "DecimalTextBox") && (dsBusinessRule.Tables[0].Rows[25]["Id"].ToString() == "26") && (blnmaxnormalvalue))
                {
                ...
                // For Min Normal
                if ((GblIQCare.strDisplayType.ToString() == "Numeric" || GblIQCare.strDisplayType.ToString() == "DecimalTextBox") && (dsBusinessRule.Tables[0].Rows[26]["Id"].ToString() == "27") && (blnminnormalvalue))
                {
                ...
                if ((GblIQCare.strDisplayType.ToString() == "Numeric" || GblIQCare.strDisplayType.ToString() == "DecimalTextBox") && (blnmaxnormalvalue) && (blnminnormalvalue))
                {
                ...
                if ((GblIQCare.strDisplayType.ToString() == "Numeric" || GblIQCare.strDisplayType.ToString() == "DecimalTextBox") && (blnminnormalvalue) && (blnminvalue))
                {
                ...
                if ((GblIQCare.strDisplayType.ToString() == "Numeric" || GblIQCare.strDisplayType.ToString() == "DecimalTextBox"))
                {
                    if ((blnmaxvalue == true) && (blnminvalue == false))
                    {
                        IQCareWindowMsgBox.ShowWindow("EnterCorrectMinMaxSelect", this);
                        return false;
                    }
                    else if ((blnmaxvalue == false) && (blnminvalue == true))
                    {
                        IQCareWindowMsgBox.ShowWindow("EnterCorrectMinMaxSelect", this);
                        return false;
                    }
                    else if ((blnmaxnormalvalue == true) && (blnminnormalvalue == false))
                    {
                        IQCareWindowMsgBox.ShowWindow("EnterCorrectMinMaxNormalSelect", this);
                        return false;
                    }
                    else if ((blnmaxnormalvalue == false) && (blnminnormalvalue == true))
                    {
                        IQCareWindowMsgBox.ShowWindow("EnterCorrectMinMaxNormalSelect", this);
                        return false;
                    }
                    else if ((blnmaxnormalvalue == true) && (blnminnormalvalue == true))
                    {
        ...
        {
            GblIQCare.blnICD10multiselect = true;
            Form theForm;
