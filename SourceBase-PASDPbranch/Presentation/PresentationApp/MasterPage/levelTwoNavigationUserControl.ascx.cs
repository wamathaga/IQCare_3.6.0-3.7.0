...
public partial class MasterPage_levelTwoNavigationUserControl : System.Web.UI.UserControl
{
    ...
    public void LoadCreateNewMenu(String url, int i)
    {
        if (!IsPostBack)
        {
            ...
            //else if (Convert.ToInt32(dtrules.Rows[i]["FeatureId"]) == 3)
            //{
    ...
    private void Load_MenuCreateNewForm()
    {
        ...
        foreach (DataRow theDR in dtrules.Rows)
        {
            if (Convert.ToInt32(theDR["Featureid"]) != 71)
            {
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); divUgandaBlueCard(); divKHNPEP(); ClinicID();
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); divUgandaBlueCard(); divKHNPEP(); divPMTCT();
                    LoadCreateNewMenu(theURL, rowNo);
                    if (lblpntStatus.Text != "1")
                    {
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); ClinicID(); divKHNPEP(); divPMTCT();
                    if (lblpntStatus.Text != "1")
                    {
                        if (theLabTest != "")
                        {
                ...
                {
                    DivDynModule(); divUgandaBlueCard(); ClinicID(); divKHNPEP(); divPMTCT();
                    if (lblpntStatus.Text != "1")
                    {
                        if (theLabTest != "")
                        {
                ...
                {
                    DivDynModule(); ClinicID(); divPMTCT();
                ...
                else
                {
                    ...
                    {
                        divKenyaBlueCard(); divUgandaBlueCard(); ClinicID(); divKHNPEP(); divPMTCT();
                        LoadCreateNewMenu(theURL, rowNo);
                    }
                    else
                    {
    ...
    private void Init_Menu()
    {
        ...
        if (lblpntStatus.Text == "0" && (PtnARTStatus == 0 || PtnPMTCTStatus == 0))
        {
            if (PtnARTStatus == 0)
            {
                ...
                //########### Adult Pharmacy ############
                //theUrl = string.Format("{0}", "../Pharmacy/frmPharmacy_Custom.aspx?Prog=ART");
        ...
        theUrl = string.Format("{0}?PatientId={1}", "../ClinicalForms/frmClinical_KNH_ExpressForm.aspx", PatientId.ToString());
        ...
        theUrl = string.Format("{0}?PatientId={1}", "../ClinicalForms/frmClinical_KNH_PEP.aspx", PatientId.ToString());
        AssignUrl(patientLevelMenu.Items, "mnuknhpep", theUrl);

        theUrl = string.Format("{0}?PatientId={1}", "../ClinicalForms/frmClinical_KNH_AdultIE.aspx", PatientId.ToString());
        AssignUrl(patientLevelMenu.Items, "mnuknhadultIE", theUrl);

        theUrl = string.Format("{0}?PatientId={1}", "../ClinicalForms/frmClinical_KNH_Paediatric_IE.aspx", PatientId.ToString());
