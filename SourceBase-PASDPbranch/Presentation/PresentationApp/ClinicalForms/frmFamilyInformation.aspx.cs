...
public partial class ClinicalForms_frmFamilyInformation : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //(Master.FindControl("lblheader") as Label).Text = "Family Information";
        ...
        //(Master.FindControl("lblformname") as Label).Text = "Family Information";
        BindHeader();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        btnSubmit.Enabled = false;
        SaveCancel();
        //IQCareMsgBox.Show("SaveSuccess", this);
