                                                    ...
                                                    <asp:Panel ID="pnlstagingYN" runat="server">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h2 align="left" class="forms">
                                                                       <asp:Literal ID="literalStaging" runat="server" Text="Staging"></asp:Literal>  </h2>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </asp:Panel>
                                                        ...
                                                        <tr>
                                                            <td width="50%" class="border pad5 whitebg">
                                                                <table width="100%">
                                                                    <tr>
                                                                        <td align="right" style="width: 55%;">
                                                                            <asp:Label ID="lblWHOStage" runat="server" CssClass="required" Font-Bold="True"
                                                            Text="*Current WHO Stage:"></asp:Label>
                                                                        </td>
                                                                        <td align="left" class="data-control">
                                                            ...
                                                            <td width="50%" class="border pad5 whitebg">
                                                                <table class="tbl-left">
                                                                    <tr>
                                                        <td align="right" style="width: 40%;">
                                                            <asp:Label ID="lblWABStage" runat="server" CssClass="required" Font-Bold="True"
                                                            Text="*WAB Stage:"></asp:Label>
                                                        </td>
                                                        <td align="left" >
