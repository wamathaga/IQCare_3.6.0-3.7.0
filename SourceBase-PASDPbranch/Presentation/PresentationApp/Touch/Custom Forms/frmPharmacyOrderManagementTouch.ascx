<%@ Control Language="C#" AutoEventWireup="True" Inherits="Touch.Custom_Forms.frmPharmacyOrderManagementTouch"
    CodeBehind="frmPharmacyOrderManagementTouch.ascx.cs" %>
                    ...
                    <tr>
                        <td>
                            <telerik:RadGrid ID="rgviewpharmacyform" Skin="MetroTouch" AutoGenerateColumns="false"
                                ...
                                OnItemDataBound="rgviewpharmacyform_ItemDataBound" Culture="(Default)">
                                <MasterTableView PageSize="5" Font-Size="10" DataKeyNames="OrderID">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn UniqueName="visitid" DataField="visit_id" Display="false">
                                         ...
                                         <telerik:GridBoundColumn UniqueName="ShowAction" DataField="ShowAction" Display="false">
                                        </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn SortExpression="OriginalOrderID" HeaderText="Original Order ID"
                                    HeaderButtonType="TextButton" DataField="OriginalOrderID">
                                        ...
                                        <telerik:GridButtonColumn SortExpression="Edit" Visible="True" UniqueName="EditPharmacy" CommandName="Edit1"
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <telerik:RadButton ID="rdcontinueorder" runat="server" Text="Continue ARVs" OnClientClicked="parent.ShowLoading"
                                    OnClick="rdcontinueorder_Click">
                                </telerik:RadButton>
                                <telerik:RadButton ID="btnInvisShowLoading"  style="display: none;" runat="server" Text="InvisShowLoading"  ButtonType="LinkButton" OnClientClicked="parent.ShowLoading" ></telerik:RadButton>
                            </td>
                            <td>
