                                ...
                                <ContentTemplate>
                                    ...
                                    <table cellpadding="10px" class="Section">
                                        <tr>
                                            ...
                                            <td style="width: 80%;" >
                                                <telerik:RadComboBox ID="cbAllergen" runat="server" Width="550px" Height="400px">
                                                </telerik:RadComboBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width: 80%;">
                                                <telerik:RadTextBox ID="txtTOR" runat="server" Skin="MetroTouch" Width="550px">
                                                </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 80%;">
                                                <telerik:RadTextBox ID="txtRMC" runat="server" Skin="MetroTouch" Width="550px">
                                                </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                    </table>
