...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="server">
    ...
    .RadAutoCompleteBox_Metro .racItem,
    .RadAutoCompleteBox_Metro .racInput,
    .RadAutoCompleteBox_Metro .racHovered
    {  
                                    ...
                                    <table style="text-align: left">
                                        <tr>
                                            ...
                                            <td  style="text-align: left">
                                                <telerik:RadAutoCompleteBox ID="Autoselectdrug" runat="server" Skin="Metro"      
                                                Width="700px" DropDownWidth="500px"  onentryadded="Autoselectdrug_EntryAdded" TextSettings-SelectionMode="Single">
                            ...
                            <tr>
                                ...
                                <div class="mid" style="cursor: pointer; height: 280px; overflow: auto;border: 1px solid #666699;">
                                    <telerik:RadGrid ID="rgdrugmain" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                        AllowMultiRowSelection="False" AllowPaging="false" PageSize="5" GridLines="None" Skin="Metro"
                                                    ...
                                                    <telerik:RadMultiPage runat="server" ID="Multipage1" SelectedIndex="0" RenderSelectedPageOnly="false">
                                                            ...
                                                            <telerik:RadGrid runat="server" ID="Dispense" ShowFooter="true" AllowSorting="true"
                                                                ...
                                                                <MasterTableView ShowHeader="true" AutoGenerateColumns="False" AllowPaging="true"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridTemplateColumn HeaderText="Quantity Prescribed" DataField="QtyPrescribed">
                                                                            <ItemTemplate>
                                                                                <telerik:RadNumericTextBox runat="server" Skin="Metro" ReadOnly="true" NumberFormat-DecimalDigits="2" MaxLength="4" Width="50px" ID="txtQtyPrescribeddispense" Text='<%# Eval("QtyPrescribed") %>'>
                                                                                </telerik:RadNumericTextBox>
                                                                            </ItemTemplate>
                                                                        </telerik:GridTemplateColumn>
                                                                            <telerik:GridTemplateColumn HeaderText="Total Available Quantity" DataField="AvailQty">
                                                                            <ItemTemplate>
                                                                                <telerik:RadNumericTextBox runat="server" Skin="Metro" ReadOnly="true" NumberFormat-DecimalDigits="2" MaxLength="4" Width="50px" ID="txtAvailQty">
                                                                                </telerik:RadNumericTextBox>
                                                                            </ItemTemplate>
                                                                        </telerik:GridTemplateColumn>
                                                                        ...
                                                                        <telerik:RadTextBox ID="txtExpiryDate" Skin="Metro" ReadOnly="true" Width="120px" runat="server" DataTextField="ExpiryDate"></telerik:RadTextBox>
                                                                         ...
                                                                         <telerik:GridTemplateColumn HeaderText="Selling Price" DataField="SellPrice">
                                                                            <ItemTemplate>
                                                                                <telerik:RadNumericTextBox runat="server" Skin="Metro" NumberFormat-DecimalDigits="2" MaxLength="4" DataTextField="SellPrice" Width="50px" ID="txtSellPrice">
                                                                                </telerik:RadNumericTextBox>
                                                                            </ItemTemplate>
                                                                        </telerik:GridTemplateColumn>
                                                                        <telerik:GridTemplateColumn HeaderText="Bill Amount" DataField="BillAmount">
                                                                            <ItemTemplate>
                                                                                <telerik:RadNumericTextBox runat="server" Skin="Metro" NumberFormat-DecimalDigits="2" MaxLength="4"
                                                        ...
                                                        <telerik:RadPageView runat="server" ID="PageView3" Width="460px" Skin="Metro">
                                                            <telerik:RadGrid runat="server" ID="Refill" ShowFooter="true" AllowSorting="true"
                                                                OnNeedDataSource="Refill_NeedDataSource" EnableLinqExpressions="false" Skin="Metro">
                                                                <ValidationSettings EnableValidation="true" CommandsToValidate="PefrormInsert" />
                                                                <MasterTableView ShowHeader="true" AutoGenerateColumns="False" AllowPaging="true"
                                                                    DataKeyNames="DrugID" PageSize="7" HierarchyLoadMode="ServerOnDemand">
                                                                    <Columns>
