<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/MasterPage/IQCare.master"
    AutoEventWireup="true" Inherits="ClinicalForms_frmFamilyInformation"
    Title="untitled page" Codebehind="frmFamilyInformation.aspx.cs" %>
...
<%--<head> 
    ...
    <title id="lblHeader" runat="server">Family Information</title>
...
<link type="text/css" href="../Style/_assets/css/round.css" rel="stylesheet" />
    <form id="frmFamilyInformation" method="post" runat="server">--%>
    <script language="javascript" type="text/javascript">
        ...
        function fnValidate() {
            ...
            //            {
            //                alert("Relationship Type not selected");
            //                document.getElementById('<%=ddlrelationtype.ClientID%>').focus();
            //                return false;
            //            }
            else if (document.getElementById('<%=ddlrelationtype.ClientID%>').value != "0") {
                if (document.getElementById('<%=ddlrelationtype.ClientID%>').value == "3" || document.getElementById('<%=ddlrelationtype.ClientID%>').value == "11") {
                    //                    if(document.getElementById('<%=txtRelationDate.ClientID%>').value=="")
                    //                    {
                    //                        alert("Birth/Marriage date cannot be blank");
                    //                        document.getElementById('<%=txtRelationDate.ClientID%>').focus();
                    //                        return false;
                    //                    }
                }
            }
                            ...
                            <td colspan="2">
                                <div id="divART" runat="server">
                                    ...
                                    <td class="form" align="center">
                                        <label class="patientInfo">
                                            Patient ID:
                                            <asp:Label ID="lblpatientid" runat="server" Text="" Font-Bold="false"></asp:Label></label>
                                        <label class="patientInfo">
                                            <asp:Label ID="lbldisplay" runat="server"></asp:Label>
                                            <asp:Label ID="lblfileno" runat="server" Text="" Font-Bold="false"></asp:Label></label>
                                    </td>
                                </tr>--%>
                                    </table>
                                </div>
