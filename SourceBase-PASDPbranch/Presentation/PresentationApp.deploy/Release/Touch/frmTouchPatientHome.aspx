...
<body>
    ...
    <div id="extruderLeft" class="a {title:'<% Response.Write(lblName.Text); %>'}" style="font-size: 12px;
        ...
        <div id="LeftPane" class="LeftPane">
            ...
            <img src="images\divider.png" alt="divider" />
            <br />
            <span class="quickbarLinklab" onclick="ShowGraphs('divlabAlert')">Labs Alert</span><br />
            ...
            <div id="divlabAlert" onclick="ShowGraphs('divlabAlert')" style="overflow: scroll;
                width: 700px; height: 400px; position: fixed; left: 250px; top: 154px; background-color: white;
                display: none">
            ...
            <div id="divshowlabs" onclick="ShowGraphs('divshowlabs')" style="width: 700px; height: 400px;
                position: fixed; left: 250px; top: 154px; background-color: white; display: none">
                <table style="width: 100%">
                    <tr>
                        <td colspan="2" align="right">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function PrintFormExec(arrExtStylsheetFiles, FormName) {
                ...
                theContent = theContent.replace(/display: none;/g, "display:inline");
