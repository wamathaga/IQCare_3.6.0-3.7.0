<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="true" Inherits="Scheduler_frmHome_Visit" Title="Untitled Page" Codebehind="frmHome_Visit.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    ...
    <asp:Label ID="lblpatientname" runat="server" Text="Mary Longlastname"></asp:Label>
        <LABEL class=patientInfo>Satellite #:</LABEL>
    <asp:Label ID="lblsateliteid" runat="server" Text="99"></asp:Label>
    <LABEL class=patientInfo>Patient Enrollment #:</LABEL> 
