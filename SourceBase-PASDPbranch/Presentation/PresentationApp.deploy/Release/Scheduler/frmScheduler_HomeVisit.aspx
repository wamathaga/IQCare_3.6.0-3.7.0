<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="true" Inherits="frmScheduler_HomeVisit" Title="Untitled Page" Codebehind="frmScheduler_HomeVisit.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    <%--    <form id="HomeVisit" method="post" runat="server" enableviewstate="True">--%>
    <div class="center" style="padding: 8px;">
        <!--<h3 class="margin" align="left"><asp:Label ID="lblH2" runat="server"></asp:Label></h3>-->
        <%--<h1 class="topmarginHomeVisit">
            Home Visit</h1>
                ...
                <tbody>
                    <%-- <tr>
                        <td class="formcenter" colspan="2">
                            ...
                            <asp:Label ID="lblexisclinicid" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    --%>
                    <tr>
                    ...
                    <tr>
                        <td class="form" width="50%">
                            ...
                            <%--<input name=guardian2 id="txtAlternateCHW" runat="server" maxlength="50">--%>
                        </td>
                        <td class="form">
