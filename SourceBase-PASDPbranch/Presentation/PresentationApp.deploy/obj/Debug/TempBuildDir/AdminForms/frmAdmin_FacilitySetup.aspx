<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="True"
    EnableViewState="true" Inherits="frmAdmin_FacilitySetup"
    Title="Untitled Page" Codebehind="frmAdmin_FacilitySetup.aspx.cs" %>
                    ...
                    <table width="100%">
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <input id="Radio1" onmouseup="up(this);" onfocus="up(this);" onclick="down(this);" checked="true"
                                            type="radio" value="0" name="templete" runat="server" />
                ...
                <tr>
                    <td class="border pad5 whitebg" valign="top" width="50%">
                            ...
                            <tr>
                                <td>
                                    <div class="center whitebg" id="paperless" runat="server">
                                        <label class="center">
                                            Paperless clinic:
                                            <input type="checkbox" id="chkPaperlessclinic" runat="server" /></label>
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    <div class="center whitebg" id="strongpassword" runat="server">
                                        <label class="center">
                                            Strong Password:
                                            <input type="checkbox" id="chkStrongPwd" runat="server" /></label>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        <table width="100%">
                            <tr>
                                <td>
                                    <div class="whitebg" id="divexppwd" runat="server">
                                        <label class="center">
                                            Expire Password:
                                            <input type="checkbox" id="chkexpPwd" onclick="toggle('divnoofdays');" runat="server" /></label>
                                    </div>
