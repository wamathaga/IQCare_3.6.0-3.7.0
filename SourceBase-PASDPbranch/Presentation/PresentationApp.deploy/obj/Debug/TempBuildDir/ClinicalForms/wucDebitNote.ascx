<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="ClinicalForms_wucDebitNote" Codebehind="wucDebitNote.ascx.cs" %>
            ...
            <td colspan="2" style="width: 100%" width="50%">
                <div class="grid">
                    <div id="div1" class="gridviewDebitNote whitebg">
                         <asp:GridView ID="GridViewTran" runat="server" AutoGenerateColumns="False" CssClass="datatable" GridLines="None" AllowSorting="True">
                            <Columns>
