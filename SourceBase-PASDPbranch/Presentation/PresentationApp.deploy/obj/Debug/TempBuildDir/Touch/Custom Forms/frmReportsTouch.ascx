...
<div id="FormContent">
            ...
            <asp:UpdatePanel ID="updtreport" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <telerik:RadWindowManager ID="RadWindowManager1" ShowContentDuringLoad="false" VisibleStatusbar="false"
                        ...
                        <Windows>
                            <telerik:RadWindow ID="RadWindow1" runat="server" Behaviors="Maximize,Close" Width="1000px"
                                Height="550px" NavigateUrl="~/Touch/Custom Forms/frmReportView.aspx" Title="Report"
                                Modal="true">
                            </telerik:RadWindow>
                            <telerik:RadWindow ID="RadWindow2" runat="server" Behaviors="Maximize,Close" Width="1000px"
    ...
    <telerik:RadWindow runat="server" ID="rwLabHistory" VisibleOnPageLoad="false" Title="Lab History"
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <telerik:RadGrid ID="rgvlabhistory" Skin="MetroTouch" AutoGenerateColumns="false"
                                        runat="server" ClientSettings-Scrolling-AllowScroll="True">
