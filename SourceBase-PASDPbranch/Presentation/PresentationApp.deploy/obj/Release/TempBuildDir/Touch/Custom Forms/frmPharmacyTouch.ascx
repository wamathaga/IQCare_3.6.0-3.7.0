...
<div style="visibility: collapse">
    <telerik:RadButton ID="btnSave" runat="server" OnClientClicking="loadsavepanel" OnClick="RadButton1_Click" Visible="true"
        Text="Save">
    </telerik:RadButton>
</div>
<div id="FormContent">
                ...
                <ContentTemplate>
                    ...
                    <table id="Table4" cellpadding="10px" class="Section">
                        <tr>
                            ...
                            <td>
                                <telerik:RadTextBox runat="server" Skin="MetroTouch"  CssClass="hex"
                    ...
                    <table id="Table10" cellpadding="10px" class="Section">
                        <tr>
                            <td style="width: 100%" align="center">
                                <telerik:RadButton ID="PrintPrescription" runat="server" Skin="MetroTouch" OnClick="PrintPrescription_Click" Text="Print Prescription">
                                </telerik:RadButton>
                                &nbsp;&nbsp;
