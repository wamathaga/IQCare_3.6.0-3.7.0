...
<table width="100%"><tr align="left"><td width="50%">
    ...
    <div class="border center formbg">
        ...
        <tr><td class="form" align="center"><asp:Button ID="btnTriageSave" runat="server" Text="Save" 
            ...
            <asp:Button ID="btnTraigeDQC" 
                ...
                runat="server" Text="Close" onclick="btnTriageClose_Click" /><asp:Button ID="btnTraigePrint" runat="server" 
                Text="Print" OnClientClick="WindowPrint();" /></td></tr></table>   
    </div>   
    ...
    <act:TabPanel ID="TBPanel" runat="server" HeaderText="TB Management">
