    ...
    class BLaboratory:ProcessBase, ILaboratory
    {
        ...
        public DataTable GetLabList(int labTestId)
        {
            lock (this)
            {
                ...
                return (DataTable)Lablist.ReturnObject(ClsUtility.theParams, "pr_SCM_GetLaboratoryList_Futures", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public DataTable GetLabLocationList()
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                return (DataTable)LabLocation.ReturnObject(ClsUtility.theParams, "pr_FormBuilder_GetLabTestLocationList_Futures", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public int SaveUpdateLabConfiguration(DataTable dtLabConfig,int UserId)
        {
            ...
            foreach (DataRow theDR in dtLabConfig.Rows)
            {
                ...
                theRowAffected = (int)ItemList.ReturnObject(ClsUtility.theParams, "pr_SCM_SaveUpdateLabConfigration_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
            }
