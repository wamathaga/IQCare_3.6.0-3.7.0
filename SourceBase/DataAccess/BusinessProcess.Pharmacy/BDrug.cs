    ...
    public class BDrug : ProcessBase, IDrug
    {
        ...
        public DataTable CheckARTStopStatus(int PatientId)
        {
            lock (this)
            {
                ...
                return (DataTable)PharmacyManager.ReturnObject(ClsUtility.theParams, "Pr_Pharmacy_GetARTStopStatus_Futures", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public DataSet GetPharmacyMasters(int PatientId)
        {
            lock (this)
            {
                ...
                return (DataSet)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetMasterDetails_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetGenericID_CTC_Detail(int RegimenID)
        {
            lock (this)
            {
                ...
                return (DataSet)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetGernricRegimenDetails_CTC_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet Get_TBRegimen_Detail(int RegimenID)
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@RegimenID", SqlDbType.Int, RegimenID.ToString());
                return (DataSet)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetTBRegimenDetails_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        #endregion
        ...
        public DataSet GetNonARTDate(int PatientId)
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@PatientID", SqlDbType.Int, PatientId.ToString());
                return (DataSet)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetNonARTDate_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        #endregion
        ...
        public DataTable GetEmployeeDetails()
        {
            lock (this)
            {
                ClsObject PharmacyManager = new ClsObject();
                ClsUtility.Init_Hashtable();
                return (DataTable)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetEmployeeDetails_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        #endregion
        ...
        public DataSet GetPharmacyList(int PatientID)
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@PatientID", SqlDbType.Int, PatientID.ToString());
                return (DataSet)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetPharmacyList", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public DataSet GetExistPharmacyDetail(int PharmacyID)
        {
            lock (this)
            {
                ...
                return (DataSet)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetExistPharmacyDetails", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public DataSet GetExistPharmacy_CTC_Detail(int PharmacyID)
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@PharmacyID", SqlDbType.Int, PharmacyID.ToString());
                return (DataSet)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetExistPharmacy_CTC_Details", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetExistPharmacyForm(int PatientID, DateTime OrderedByDate)
        {
            lock (this)
            {
                ...
                return (DataSet)PharmacyManager.ReturnObjectNewImpl(ClsUtility.theParams, "pr_Pharmacy_AgeValidate_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataTable GetStrengthForFixedDrug(int Drug_pk)
        {
            lock (this)
            {
                ...
                return (DataTable)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetStrengthForFixedDrug_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        #endregion
        #region "FixedDrugStrength"
        public DataTable GetFrequencyForFixedDrug(int Drug_pk)
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@Drug_pk", SqlDbType.Int, Drug_pk.ToString());
                return (DataTable)PharmacyManager.ReturnObject(ClsUtility.theParams, "[pr_Admin_GetFrequencyForFixedDrug_Constella]", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        #endregion
        ...
        public DataSet FillDropDown()
        {
            lock (this)
            {
                ...
                return (DataSet)DrugManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetFrquencyStrength_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public int SaveUpdateDrugOrder(int patientID, int LocationID, int PharmacyId, int RegimenLine, string PharmacyNotes, int OrderedBy, DateTime OrderedByDate, int DispensedBy, DateTime DispensedByDate, int HoldMedicine, int Signature, int EmployeeID, int OrderType, int UserID, DataTable DrugTable, DataSet Master, int ProgID, int ProviderID, DataTable theCustomFieldData, int PeriodTaken, int flag, int SCMFlag)
        {
            ...
            try
            {
                ...
                if (flag == 2)
                {
                    //ClsUtility.Init_Hashtable();
                    //ClsUtility.AddParameters("@ptn_pharmacy_pk", SqlDbType.Int, PharmacyId.ToString());
                    //theRowAffected = (int)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_DeletePharmacyDetail_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                theDR = (DataRow)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_SaveUpdatePharmacy_Constella", ClsDBUtility.ObjectEnum.DataRow);
                ...
                for (int i = 0; i < DrugTable.Rows.Count; i++)
                {
                    ...
                    theRowAffected = (int)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_Save_PatientPharmacyDetails_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                for (Int32 i = 0; i < theCustomFieldData.Rows.Count; i++)
                {
                    ...
                    int RowsAffected = (Int32)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_General_Dynamic_Insert", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
        ...
        public int SaveDrugOrder(int patientID, int LocationID, int OrderedBy, DateTime OrderedByDate, int DispensedBy, DateTime DispensedByDate, int HoldMedicine, int Signature, int EmployeeID, int OrderType, int UserID, DataTable DrugTable, DataSet Master, int ProgID, int ProviderID, DataTable theCustomFieldData,int PeriodTaken)
        {
            ...
            try
            {
                ...
                ClsUtility.AddParameters("PeriodTaken", SqlDbType.Int, PeriodTaken.ToString());
                ClsUtility.AddParameters("@Prophylaxis", SqlDbType.Int, Prophylaxis.ToString());
                theDR = (DataRow)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_SavePharmacy_Constella", ClsDBUtility.ObjectEnum.DataRow);
        ...
        public DataSet GetARVStatus(int patientid, DateTime DispensedBy)
        {
            lock (this)
            {
                ...
                return (DataSet)DrugManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetARVStatus_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public int SaveUpdateDrugOrder_CTC(int patientID, int LocationID,int PharmacyId, int OrderedBy, DateTime OrderedByDate, int DispensedBy, DateTime DispensedByDate, int HoldMedicine, int Signature, int EmployeeID, int OrderType, int UserID, DataTable DrugTable, DataSet Master, int ProgID, int ProviderID, DataTable theCustomFieldData,int flag)
        {
            ...
            try
            {
                ...
                if (flag == 2)
                {
                    ClsUtility.Init_Hashtable();
                    ClsUtility.AddParameters("@ptn_pharmacy_pk", SqlDbType.Int, PharmacyId.ToString());
                    theRowAffected = (int)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_DeletePharmacyDetail_CTC_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                ClsUtility.AddParameters("@Prophylaxis", SqlDbType.Int, Prophylaxis.ToString());
                ClsUtility.AddParameters("@flag", SqlDbType.Int, flag.ToString());
                theDR = (DataRow)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_SaveUpdatePharmacy_CTC_Constella", ClsDBUtility.ObjectEnum.DataRow);
                ...
                for (int i = 0; i < DrugTable.Rows.Count; i++)
                {
                    ...
                    theRowAffected = (int)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_Save_PatientPharmacyDetails_CTC_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public int SaveDrugOrder_CTC(int patientID, int LocationID, int OrderedBy, DateTime OrderedByDate, int DispensedBy, DateTime DispensedByDate, int HoldMedicine, int Signature, int EmployeeID, int OrderType, int UserID, DataTable DrugTable, DataSet Master, int ProgID, int ProviderID,  DataTable theCustomFieldData)
        {
            ...
            try
            {
                ...
                theDR = (DataRow)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_SavePharmacy_CTC_Constella", ClsDBUtility.ObjectEnum.DataRow);
                ...
                //        theRowAffected = (int)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_General_Dynamic_Insert", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public int UpdateExistDrug(int patientID, int LocationID, int PharmacyId, int OrderedBy, DateTime OrderedByDate, int DispensedBy, DateTime DispensedByDate, int HoldMedicine, int Signature, int EmployeeID, int OrderType, int UserID, DataTable DrugTable, DataSet Master, int ProgID, int ProviderID, DataTable theCustomFieldData, int PeriodTaken)
        {
            ...
            try
            {
                ...
                ClsUtility.AddParameters("@PeriodTaken", SqlDbType.Int, PeriodTaken.ToString());
                ClsUtility.AddParameters("@Prophylaxis", SqlDbType.Int, Prophylaxis.ToString());
                theRowAffected = (int)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_UpdatePharmacyDetail_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public int UpdateExistDrug_CTC(int patientID, int PharmacyId, int OrderedBy, DateTime OrderedByDate, int DispensedBy, DateTime DispensedByDate, int HoldMedicine, int Signature, int EmployeeID, int OrderType, int UserID, DataTable DrugTable, DataSet Master, int ProgID, int ProviderID, DataTable theCustomFieldData)
        {
            ...
            try
            {
                ...
                theRowAffected = (int)PharmacyManager.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_UpdatePharmacyDetail_CTC_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public int DeleteDrugForms(string FormName, int OrderNo, int PatientId, int UserID)
        {
            ...
            try
            {
                ...
                theAffectedRows = (int)DeleteDrugForm.ReturnObject(ClsUtility.theParams, "pr_Clinical_DeletePatientForms_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public DataSet GetPharmacyNotes(int PatientID)
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@PatientID", SqlDbType.Int, PatientID.ToString());
                return (DataSet)thePN.ReturnObject(ClsUtility.theParams, "pr_Pharmacy_GetPharmacyNotes_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        //John Macharia - End
        ...
        public DataSet GetDrugInstructions(Int32 DrugId)
        {
            ...
            return (DataSet)theManager.ReturnObject(ClsUtility.theParams, "pr_SCM_GetDrugInstructions", ClsDBUtility.ObjectEnum.DataSet);
        }
