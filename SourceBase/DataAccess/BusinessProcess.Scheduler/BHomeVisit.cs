    ...
    class BHomeVisit : ProcessBase, IHomeVisit
    {
        ...
        public DataSet GetFieldsforGrid(int Patient_ID)
        {
            lock (this)
            {
                ...
                return (DataSet)HomeVisitManager.ReturnObject(ClsUtility.theParams, "pr_Scheduler_GetHomeVisitList_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        #endregion
        ...
        public DataSet GetFieldsforAdd(int Patient_ID)
        {
            lock (this)
            {
                ...
                return (DataSet)HomeVisitManager.ReturnObject(ClsUtility.theParams, "pr_Scheduler_SelectHomeVisitfields_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        #endregion
        ...
        public DataSet GetFieldsforEdit(int Patient_ID, int HomeVisitID, DataTable theCustomFieldData)
        {
            lock (this)
            {
                ...
                return (DataSet)HomeVisitManager.ReturnObject(ClsUtility.theParams, "pr_Scheduler_SelectEditHomeVisitfields_Constella", ClsDBUtility.ObjectEnum.DataSet);
                ...
                for (Int32 i = 0; i < theCustomFieldData.Rows.Count; i++)
                {
                    ...
                    int RowsAffected = (Int32)HomeVisitManager.ReturnObject(ClsUtility.theParams, "pr_General_Dynamic_Insert", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
            }
        ...
        public DataSet SaveHomeVisit(int LocationID, int ptn_pk, string PatientCHW, string PatientAlternateCHW, int hvPerWeek1, int hvPerWeek2, int hvPerWeek3, int hvPerWeek4, int VisitsPerWeek, int Duration, DateTime StartDate, int UserId, int HomeVisitID, int Flag, int DataQualityFlag,  DataTable theCustomFieldData)
        {
            ...
            try
            {
                ...
                //////if (Flag == 0)
                //////{
                //////    theDT = (DataSet)HomeVisitManager.ReturnObject(ClsUtility.theParams, "pr_Scheduler_SaveHomeVisit_Constella", ClsDBUtility.ObjectEnum.DataSet);
                //////}
                //////else if (Flag == 1)
                //////{
                //////    theDT = (DataSet)HomeVisitManager.ReturnObject(ClsUtility.theParams, "pr_Scheduler_UpdateHomeVisit_Constella", ClsDBUtility.ObjectEnum.DataSet);
                    
                //////}
                theDT = (DataSet)HomeVisitManager.ReturnObjectNewImpl(ClsUtility.theParams, "pr_Scheduler_UpdateHomeVisit_Constella", ClsDBUtility.ObjectEnum.DataSet);
                //// Custom Fields //////////////
                ////////////PreSet Values Used/////////////////
                /// #99# --- Ptn_Pk
                /// #88# --- LocationId
                ...
                ////ClsUtility.Init_Hashtable();
                ////DataTable DTVisitID = (DataTable)HomeVisitManager.ReturnObject(ClsUtility.theParams, theSQL, ClsDBUtility.ObjectEnum.DataTable);
        ...
        public int DeleteHomeVisitForms(string FormName, int OrderNo, int PatientId, int UserID)
        {
            ...
            try
            {
                ...
                theAffectedRows = (int)DeleteHomeVisitForm.ReturnObject(ClsUtility.theParams, "pr_Clinical_DeletePatientForms_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
