...
namespace Interface.FormBuilder
{
    public interface ICareEndedConfiguration
    {
        ...
        int SaveCareEndDetails(DataSet dsCareEndDetail, Int32 FeatureId, string FeatureName, String SectionName, Int32 ModuleId, Int32 UserId, String CountryId, Int32 SectionId, DataTable dtconditionalFields, DataTable theDeathReason, int FacilityId);
