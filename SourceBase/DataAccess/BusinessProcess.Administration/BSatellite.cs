    ...
    public class BSatellite : ProcessBase,ISatellite
    {
        public DataTable GetAllSatellite()
        {
            try
            {
                ...
                return (DataTable)SatelliteGetMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectSatellite_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
            catch
            {
                throw;
        ...
        public DataTable GetSatellite(int ID)
        {
            try
            {
                ...
                return (DataTable)SatelliteEditMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_GetSatellite_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
            catch
            {
                throw;
        ...
        public DataSet GetSatelliteByID_Edit(string ID)
        {
            try
            {
                ...
                return (DataSet)SatelliteEditMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_GetSatelliteEdit_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
            catch
            {
                throw;
        ...
        public DataTable GetSatelliteByID_Name(string SatID, string SatName)
        {
            try
            {
                ...
                return (DataTable)SatelliteEditMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_GetSatellitebyID_Name_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
            catch
            {
                throw;
        ...
        public int SaveUpdateSatellite(String ID, String SatelliteID, String SatelliteName, String status, int priority, int Flag, int UserID, String Createdate)
        {
            try
            {
                ...
                if (Flag == 0)
                {
                    RowsAffected = (Int32)SatelliteMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_SaveSatellite_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                else if (Flag == 1)
                {
                    ClsUtility.AddParameters("@ID", SqlDbType.Int, ID.ToString());
                    RowsAffected = (Int32)SatelliteMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_UpdateSatellite_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                /*********/
                if (RowsAffected == 0)
                {
