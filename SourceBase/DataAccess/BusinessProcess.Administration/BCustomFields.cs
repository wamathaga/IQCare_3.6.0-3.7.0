    ...
    public class BCustomFields : ProcessBase, ICustomFields
    {
        ...
        public DataSet GetFeatures(int SystemId, string ModuleId)
        {
            lock (this)
            {
                ...
                return (DataSet)FeatureList.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectFeatureName_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetCustomList(int CodeID)
        {
            lock (this)
            {
                ...
                return (DataSet)FeatureList.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectCodeDecode_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetCustomListName(string CodeName)
        {
            lock (this)
            {
                ...
                return (DataSet)FeatureList.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectCodeName_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetCustomFields(int SystemId)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemId.ToString());
                return (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectCustomFields_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetCustomFieldsUnits(int CustomFieldID)
        {
            lock (this)
            {
                ...
                return (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectCustomFieldUnit_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetCustomFieldListforAForm(int FormID)
        {
            lock (this)
            {
                ...
                return (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectCustomFieldList_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetPatientVisit(int ptnID,int locationID,int visitType)
        {
            lock (this)
            {
                ...
                return (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectVisitID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetCustomFieldValues(string TableName, string fields, Int32 ptnID, Int32 HomeVisitId, Int32 visitpk, Int32 labID, Int32 ptn_pharmacy_pk, Int32 FeatureID)
        {
            lock (this)
            {
                ...
                return (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_General_Dynamic_Select", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        /// <summary>
        ...
        public DataSet GetDecodeValues(Int32 codeId)
        {
            lock (this)
            {
                ...
                ClsObject CustomFields = new ClsObject();
                ClsUtility.AddParameters("@codeId", SqlDbType.Int, codeId.ToString());
                return (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_GeDecodeValuesCodeIdWise_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetVisit(int VisitId)
        {
            lock (this)
            {
                ...
                return (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_VisitID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public int SaveCustomFields(string Lblfield, string lbldesc, int FeatureID, int SectionID, int ControlID, int UserID, int UnitFlag, int MinValue, int MaxValue, string UnitsNum, int CodeID, string DataType, string OldLabel, int multiSelect, int iSize, string decodeValues, string deleteValues, int SystemId,int rowcount)
        {
            try
            {
                ...
                int RowsAffected = (Int32)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_CreateCustomField_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                //ClsUtility.Init_Hashtable();
                //RowsAffected = (Int32)CustomFields.ReturnObject(ClsUtility.theParams, "pr_CustomFieldResults_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                /*
                if (RowsAffected == 0)
                {
        ...
        public int UpdateCustomFields(string Lblfield,string lbldesc, int FeatureID, int SectionID, int ControlID, int UserID, int CustomFieldID, int UnitFlag, int MinValue, int MaxValue, string UnitsNum)
        {
            ...
            try
            {
                ...
                int RowsAffected = (Int32)CustomFields.ReturnObject(ClsUtility.theParams, "Pr_Admin_UpdateCustomField_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                /*
                if (RowsAffected == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
        ...
        public int SaveCustomFieldValues(string sqlstr)
        {
            try
            {
                ...
                int RowsAffected = (Int32)CustomFields.ReturnObject(ClsUtility.theParams, "pr_General_Dynamic_Insert", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public int DeleteCustomFields(int CustomFieldID,int DFlag)
        {
            try
            {
                ...
                int RowsAffected = (Int32)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_DeleteCustomField_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                /*
                if (RowsAffected == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
        ...
        public DataSet SaveCodeDecode(string Name, string DName,int SRNO, int UserID)
        {
            ...
            try
            {
                ...
                dsCustomList = (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_AddCodeDecode_Constella", ClsDBUtility.ObjectEnum.DataSet);
                /*
        ...
        public DataSet GetRearrangeCustomFields(int SystemId)
        {
            lock (this)
            {
                ...
                ClsObject CustomFields = new ClsObject();
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemId.ToString());
                return (DataSet)CustomFields.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectRearrangeCustomFields_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public int RearrangeCustomFields(DataTable dtCustomFields, int SystemId)
        {
            try
            {
                ...
                foreach (DataRow dr in dtCustomFields.Rows)
                {
                    ...
                    ClsUtility.AddParameters("@Srno", SqlDbType.Int, sno.ToString());
                    ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemId.ToString());
                    RowsAffected = (Int32)CustomFields.ReturnObject(ClsUtility.theParams, "Pr_Admin_RearrangeCustomField_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public int SaveUpdateCustomFieldValues(string[] sqlstr)
        {
            ...
            try
            {
                ...
                for (i = 0; i < sqlstr.Length; i++)
                {
                    ...
                    RowsAffected += (Int32)CustomFields.ReturnObject(ClsUtility.theParams, "pr_General_Dynamic_Insert", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                /*
                if (RowsAffected == 0)
                {
