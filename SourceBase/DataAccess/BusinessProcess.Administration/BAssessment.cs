    ...
    public class BAssessment :ProcessBase,IAssessment 
    {
        ...
        public DataSet GetAssessmentList()
        {
            lock (this)
            {
                ...
                return (DataSet)AssessmentManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectAssessmentandCategory_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet DeleteAssessment(int AssessmentID)
        {
            lock (this)
            {
                ...
                return (DataSet)AssessmentManager.ReturnObject(ClsUtility.theParams, "pr_Admin_DeleteAssessment_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetAssessmentTypeList()
        {
            lock (this)
            {
                ClsUtility.Init_Hashtable();
                ClsObject AssessmentManager = new ClsObject();
                return (DataSet)AssessmentManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_SelectAssessmentCategory_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetAssessmentByIDList(int AssessmentID)
        {
            lock (this)
            {
                ...
                return (DataSet)AssessmentManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_SelectAssessmentByID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetAssessmentTypeByIDList(int AssessmentCategoryID)
        {
            lock (this)
            {
                ...
                return (DataSet)AssessmentManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_SelectAssessmentCategoryByID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet DeleteAssessmentType(int AssessmentCategoryID)
        {
            lock (this)
            {
                ...
                return (DataSet)AssessmentManager.ReturnObject(ClsUtility.theParams, "pr_Admin_DeleteAssessmentCategory_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        
        {
            try
            {
                ...
                DataRow theDR;
                theDR = (DataRow)AssessmentManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_InsertAssessment_Constella", ClsDBUtility.ObjectEnum.DataRow);
        ...
        public int SaveNewAssessmentType(string AssessmentCategoryName, int UserId)
        {
            try
            {
                ...
                DataRow theDR;
                theDR = (DataRow)AssessmentManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_AddAssessmentCategory_Constella", ClsDBUtility.ObjectEnum.DataRow);
                if (Convert.ToInt32(theDR[0]) == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
        ...
        public int UpdateAssessment(int AssessmentId,int AssessmentCategoryID, string AssessmentName, int UserId)
        {
            try
            {
                ...
                DataRow theDR;
                theDR = (DataRow)AssessmentManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_UpdateAssessment_Constella", ClsDBUtility.ObjectEnum.DataRow);
                if (Convert.ToInt32(theDR[0]) == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
        ...
        public int UpdateAssessmentType( int AssessmentCategoryID, string AssessmentCategoryName, int UserId)
        {
            try
            {
                ...
                DataRow theDR;
                theDR = (DataRow)AssessmentManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_UpdateAssessmentCategory_Constella", ClsDBUtility.ObjectEnum.DataRow);
                if (Convert.ToInt32(theDR[0]) == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
