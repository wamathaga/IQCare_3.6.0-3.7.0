    ...
    public class BReason : ProcessBase,IReason 
    {
        ...
        public DataSet GetReason()
        {
            lock (this)
            {
                ...
                return (DataSet)ReasonManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectReason_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet DeleteReason(int reasonid)
        {
            lock (this)
            {
                ...
                return (DataSet)ReasonManager.ReturnObject(ClsUtility.theParams, "pr_Admin_DeleteReason_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet DeleteReasonCatg(int reasontypeid)
        {
            lock (this)
            {
                ...
                return (DataSet)ReasonManager.ReturnObject(ClsUtility.theParams, "pr_Admin_DeleteReasonCategory_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetReasonCategory()
        {
            lock (this)
            {
                ClsUtility.Init_Hashtable();
                ClsObject ReasonManager = new ClsObject();
                return (DataSet)ReasonManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectReasonCategory_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetReasonCategoryByID(int reasontypeid)
        {
            lock (this)
            {
                ...
                return (DataSet)ReasonManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectReasonCategoryByID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetReasonByID(int reasonid)
        {
            lock (this)
            {
                ...
                return (DataSet)ReasonManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectReasonByID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
...
//              ClsUtility.AddParameters("@DeleteFlag", SqlDbType.Int, DeleteFlag.ToString());
                ...
                DataRow theDR;
                int RowsAffected = (Int32)ReasonManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_InsertReason_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                if (RowsAffected == 0)
                {
        ...
        public int SaveNewReasonCategory(string ReasonCategoryName, int UserID)
        {
            try
            {
                ...
                DataRow theDR;
                theDR = (DataRow)ReasonManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_InsertReasonCategory_Constella", ClsDBUtility.ObjectEnum.DataRow);
        ...
        public int UpdateReason(int ReasonID, string ReasonName, int CategoryID, int SRNo, int UserID, int DeleteFlag)
        {
            try
            {
                ...
                DataRow theDR;
                int RowsAffected = (Int32)ReasonManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_UpdateReason_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                if (RowsAffected == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
                    theBL.DataElements["MessageText"] = "Error in Saving Reason record. Try Again..";
      ...
      public int UpdateReasonCategory(int ReasonCategoryID,string ReasonCategoryName, int UserID)
        {
            try
            {
                ...
                DataRow theDR;
                theDR = (DataRow)ReasonManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_UpdateReasonCategory_Constella", ClsDBUtility.ObjectEnum.DataRow);
                if (Convert.ToInt32(theDR[0]) == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
                    theBL.DataElements["MessageText"] = "Error in Saving Reason record. Try Again..";
