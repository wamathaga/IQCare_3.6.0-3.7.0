    ...
    public class BEducation : ProcessBase,IEducation 
    {
        ...
        public DataSet GetEducation()
        {
            lock (this)
            {
                ...
                return (DataSet)EducationManager.ReturnObject(ClsUtility.theParams, "pr_Admin_Select_Education_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetEducationByID(int EducationId)
        {
            lock (this)
            {
                ...
                ClsObject EducationManager = new ClsObject();
                return (DataSet)EducationManager.ReturnObject(ClsUtility.theParams, "pr_Admin_Select_EducationByID_Constella ", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public int SaveNewEducation( int UserID, string EducationName , int Sequence)
        {
            try
            {
                ...
                DataRow theDR;
                theDR = (DataRow)EducationManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_Insert_Education_Constella", ClsDBUtility.ObjectEnum.DataRow);
        ...
        public int UpdateEducation(int EducationID, int UserID, string EducationName, int DeleteFlag, int Sequence)
        {
            try
            {
                ...
                int rowsAffected = (Int32)EducationManager.ReturnObject(ClsUtility.theParams, "pr_Admin_Update_Education_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public DataSet DeleteEducation(int EducationId)
        {
            lock (this)
            {
                ...
                return (DataSet)EducationManager.ReturnObject(ClsUtility.theParams, "pr_Admin_Delete_Education_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
