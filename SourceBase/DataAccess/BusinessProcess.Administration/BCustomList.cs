    ...
    public class BCustomList : ProcessBase, ICustomList
    {
        ...
        public DataTable GetCustomListUpdateFlag(string TableName, int ID, int SystemId)
        {
            ...
            lock (this)
            {
                ...
                return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetUpdateFlagCustomListMasters_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public DataTable GetCustomListUpdatePriortorize(string TableName, int CategoryID, string SRno, int SystemId)
        {
            ...
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemId.ToString());
                return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetUpdatePriortorizeCustomListMasters_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public DataTable GetCustomFieldList(Int32 SystemId, Int32 FacilityId)
        {
            ...
            lock (this)
            {
                ...
                return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetCustomFieldList_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public DataTable GetCustomFieldListPMTCT()
        {
            ...
            {
                ClsUtility.Init_Hashtable();
                return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetCustomFieldListFormBuilder_Features", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public DataTable GetCustomMasterLinkRecord(string TableName, Int32 CodeId)
        {
            ...
            lock (this)
            {
                ...
                return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetCustomMasterLinkRecord_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public DataTable GetCustomMasterNonSelectedRecord(string TableName)
        {
            ...
            lock (this)
            {
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@TableName", SqlDbType.VarChar, TableName);
                return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetCustomMasterLinkSelectedRecord_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        //    return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_ReturnOutput_Constella", ClsDBUtility.ObjectEnum.DataTable);
        //}
        ...
        //    return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_DecodeOutput_Constella", ClsDBUtility.ObjectEnum.DataTable);
        //}
        public int DeleteCustomMasterLinkRecord(string TableName, Int32 CodeId)
        {
            ...
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@TableName", SqlDbType.VarChar, TableName);
                ClsUtility.AddParameters("@CodeId", SqlDbType.Int, CodeId.ToString());
                Int32 RowsAffected = (Int32)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_DeleteCustomMastersLink_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                return RowsAffected;
            }
        }
        public int DeleteCustomMasterLinkRecordParticular(string TableName, Int32 CodeId)
        {
            ...
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@TableName", SqlDbType.VarChar, TableName);
                ClsUtility.AddParameters("@CodeId", SqlDbType.Int, CodeId.ToString());
                Int32 RowsAffected = (Int32)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_DeleteCustomMastersLinkParticular_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                return RowsAffected;
            }
        }
        public DataTable GetCustomMasterDetails(string TableName, int Id, int SystemId)
        {
            ...
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@ID", SqlDbType.Int, Id.ToString());
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemId.ToString());
                return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetCustomListMastersDetails_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public DataTable SaveCustomMasterRecord(string TableName, string ListName, string Name, string Code, string Stage, int Sequence, int Category, int UserId, int SystemId, int CountryID, int ModuleId, string multiplier)
        {
            ...
            try
            {
                ...
                //Int32 RowsAffected = (Int32)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_SaveCustomListMasters_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                DataTable RowsAffected = (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_SaveCustomListMasters_Constella", ClsDBUtility.ObjectEnum.DataTable);
        ...
        public DataTable GetVillageChairperson(int RegionID, int DistrictID, int WardID, int villageId)
        {
            ...
            lock (this)
            {
                ...
                return (DataTable)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetVillageChairperson_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public DataSet GetDistric(int RegionID, int SystemID)
        {
            ...
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@RegionID", SqlDbType.Int, RegionID.ToString());
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemID.ToString());
                return (DataSet)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetRegionDistric_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetWard(int DistricID, int SystemID)
        {
            ...
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemID.ToString());
                return (DataSet)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetDistricWard_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetVillage(int Ward, int SystemID)
        {
            ...
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemID.ToString());
                return (DataSet)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetWardVillage_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetLPTFPatientTransfer(int SystemID)
        {
            ...
            lock (this)
            {
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, SystemID.ToString());
                return (DataSet)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetLPTFPatientTransfer_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetLPTFPatientTransferID(int LPTFId)
        {
            ...
            lock (this)
            {
                ...
                return (DataSet)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_GetLPTFPatientTransferID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetICDList()
        {
            lock (this)
            {
                ClsObject CustomManager = new ClsObject();
                ClsUtility.Init_Hashtable();
                return (DataSet)CustomManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetICD10List_Features", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataTable SaveICDCodeRecord(Hashtable theHT,  ArrayList theAL)
        {
            ...
            try
            {
                ...
                ClsUtility.AddParameters("@UserId", SqlDbType.Int, theHT["UserId"].ToString());
                int RowsAffectedICDCode = (Int32)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_SaveCustomMastersLinkICDCodes_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                foreach(String AR in theAL)
                {
                    ...
                    ClsUtility.AddParameters("@UserId", SqlDbType.Int, theHT["UserId"].ToString());
                    int RowsAffectedModuleICDCode = (Int32)CustomManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_SaveCustomMastersLinkModuleICDCodes_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                DataMgr.CommitTransaction(this.Transaction);
                return RowsAffected;
            }
        ...
        public DataSet GetICDData(int Id, int DiseaseFlag)
        {
            lock (this)
            {
                ...
                return (DataSet)CustomManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetICD10ListData_Features", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        #endregion
    }
