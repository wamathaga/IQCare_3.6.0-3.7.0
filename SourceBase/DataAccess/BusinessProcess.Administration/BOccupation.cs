    ...
    public class BOccupation : ProcessBase, IOccupation
    {
        ...
        public DataSet GetOccupation()
        {
            lock (this)
            {
                ...
                return (DataSet)OccupationManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectOccupation_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetOccupationByID(int occid)
        {
            lock (this)
            {
                ...
                ClsObject OccupationManager = new ClsObject();
                return (DataSet)OccupationManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectOccupationByID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public int SaveNewOccupation(string OccupationName, int UserID,  int Sequence)
        {
            try
            {
              ...
              //  ClsUtility.AddParameters("@DeleteFlag", SqlDbType.Int, DeleteFlag.ToString());
                ...
                DataRow theDR;
                int RowsAffected = (Int32)OccupationManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_InsertOccupation_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                if (RowsAffected == 0)
                {
        ...
        public int UpdateOccupation(int OccupationID, string OccupationName, int UserID, int DeleteFlag, int Sequence)
        {
            try
            {
                ...
                int RowsAffected = (Int32)OccupationManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_UpdateOccupation_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                if (RowsAffected == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
                    theBL.DataElements["MessageText"] = "Error in Saving Occupation record. Try Again..";
        ...
        public void DeleteOccupation(int OccupationId)
        {
            ...
            try
            {
                ...
                OccupationManager.ReturnObject(ClsUtility.theParams, "pr_Admin_DeleteOccupation_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
