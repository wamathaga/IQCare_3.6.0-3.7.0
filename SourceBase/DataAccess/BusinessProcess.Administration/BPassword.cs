    ...
    public class BPassword : ProcessBase, IPassword
    {
        public DataSet GetUserData(int userID)
        {
            lock (this)
            {
                ...
                return (DataSet)PasswordManager.ReturnObject(ClsUtility.theParams, "pr_Admin_Select_UserIDPassword_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public int UpdatePassword(int userID, string Password)
        {
            try
            {
                ...
                RowsAffected = (int)PasswordManager.ReturnObject(ClsUtility.theParams, "pr_Admin_Update_UserIDPassword_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
