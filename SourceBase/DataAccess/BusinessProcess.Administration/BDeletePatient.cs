    ...
    class BDeletePatient : ProcessBase, IDeletePatient
    {
        public DataTable GetPatientDetails(int PatientID)
        {
            lock (this)
            {
                ...
                return (DataTable)GetPatientDetails.ReturnObject(ClsUtility.theParams, "pr_Admin_GetPatientDetailById_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        //    return (DataTable)GetPatientDetails.ReturnObject(ClsUtility.theParams, "pr_Admin_GetPatientDetailByEnrollment_Constella", ClsDBUtility.ObjectEnum.DataTable);
        //}
        ...
        public int DeletePatient(int PatientId, int UserID)
        {
            try
            {
                ...
                theAffectedRows =  (int)DeletePatientDetails.ReturnObject(ClsUtility.theParams, "pr_Admin_DeletePatient_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
