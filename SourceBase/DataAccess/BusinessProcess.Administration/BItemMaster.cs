    ...
    public class BItemMaster : ProcessBase, IItemMaster
    {
        ...
        public int GetItemTypeIDByName(string ItemTypeName)
        {
            lock (this)
            {
                ...
                ClsObject BillManager = new ClsObject();
                //return (DataTable)BillManager.ReturnObject(ClsUtility.theParams, "dbo.pr_Billing_GetAllBillableItems", ClsUtility.ObjectEnum.DataTable);
                DataTable dt = (DataTable)BillManager.ReturnObject(ClsUtility.theParams, "dbo.pr_Admin_GetItemTypeIDByName", ClsDBUtility.ObjectEnum.DataTable);
        ...
        public DataTable GetItemsForBillable(int billableItemID)
        {
            lock (this)
            {
                ...
                ClsObject BillManager = new ClsObject();
                return (DataTable)BillManager.ReturnObject(ClsUtility.theParams, "dbo.pr_Admin_GetItemsForBillable", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public void SaveBillablesItems(int BillableID, int userID, DataTable itemList)
        {
            lock (this)
            {
                ...
                BillablesManager.ReturnObject(ClsUtility.theParams, "dbo.pr_Admin_SaveItemsForBillable", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public DataTable GetItemTypes
        {
            get
            {
                lock (this)
                {
                    ...
                    return (DataTable)itemSubs.ReturnObject(ClsUtility.theParams, "Select ItemTypeID, ItemName, DeleteFlag From dbo.Mst_ItemType ORder By SRNo, ItemName;", ClsDBUtility.ObjectEnum.DataTable);
                }
            }
        }
        /// <summary>
        ...
        public System.Data.DataTable GetTypeSubType(int itemTypeID)
        {
            lock (this)
            {
                ...
                return (DataTable)itemSubs.ReturnObject(ClsUtility.theParams, "pr_Admin_GetSubItemTypes", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        /// <summary>
        ...
        public System.Data.DataTable GetSubTypesForItem(int itemID)
        {
            lock (this)
            {
                ...
                return (DataTable)itemSubs.ReturnObject(ClsUtility.theParams, "pr_Admin_GetSubTypesForItem", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        /// <summary>
        ...
        public DataTable GetItemListByType(int itemTypeID)
        {
            lock (this)
            {
                ...
                ClsUtility.AddExtendedParameters("@ItemTypeID", SqlDbType.Int, itemTypeID);
                return (DataTable)itemManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetItemsByType", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public int AddEditItem(string ItemName, int ItemTypeID, int UserID, Dictionary<int, string> ItemSubTypes = null, bool Active = true, int ItemID = -1)
        {
            lock (this)
            {
                ...
                DataRow returnRow = (DataRow)itemManager.ReturnObject(ClsUtility.theParams, "pr_Admin_InsertUpdateItem", ClsDBUtility.ObjectEnum.DataRow);
                ...
                else
                {
                    ...
                    itemManager.ReturnObject(ClsUtility.theParams, "dbo.pr_Admin_InsertSubTypeForItem", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                    return itemID;
                }
        ...
        public List<WardAdmission> GetWardAdmission(int LocationID, int? WardID=null, int? AdmissionID = null, int? PatientID = null, bool ExcludeDischarged = true)
        {
            lock (this)
            {
                try
                {
                    ...
                    DataTable returnTable = (DataTable)itemManager.ReturnObject(ClsUtility.theParams, "pr_Wards_GetAdmission", ClsDBUtility.ObjectEnum.DataTable);
                    ...
                    var _admissions = (from _row in returnTable.AsEnumerable()
                                       select new WardAdmission()
                                       {
                                           ...
                                           AdmissionNumber = _row["AdmissionNumber"].ToString(),
            ...
            lock (this)
            {
                try
                {
                    ...
                    if (WardId.HasValue)
                        ClsUtility.AddExtendedParameters("@WardID", SqlDbType.Int, WardId.Value);
                    ClsUtility.AddExtendedParameters("@LocationID", SqlDbType.Int, LocationID);
                    DataTable returnTable = (DataTable)itemManager.ReturnObject(ClsUtility.theParams, "pr_Wards_Get", ClsDBUtility.ObjectEnum.DataTable);
