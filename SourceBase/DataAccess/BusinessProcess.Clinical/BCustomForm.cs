    ...
    public class BCustomForm : ProcessBase, ICustomForm
    {
        ...
        public String GetSystemTime(int Format)
        {
            ...
            try
            {
                ...
                if (Format == 24)
                {
                    ...
                    theDR = (DataRow)MgrTime.ReturnObject(ClsUtility.theParams, theSQL, ClsDBUtility.ObjectEnum.DataRow);
                }
                else if (Format == 12)
                {
        ...
        public DataSet Validate(string FormName, string Date, string PatientId)
        {
            ...
            try
            {
                ...
                ClsUtility.AddParameters("@VisitDate", SqlDbType.VarChar, Date.ToString());
                return theDS = (DataSet)MgrValidate.ReturnObject(ClsUtility.theParams, "pr_Clinical_ValidateCustomForm_Futures", ClsDBUtility.ObjectEnum.DataSet);
        ...
        public DataSet GetFormName(int ModuleId, int CountryID)
        {
            lock (this)
            {
                ...
                return (DataSet)CustomFormMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetCustomFormName_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        #endregion
        ...
        public DataSet GetFieldName_and_Label(int FeatureId, int PatientId)
        {
            lock (this)
            {
                ...
                {
                    return (DataSet)FieldMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetCustomFormFieldLabel_Constella", ClsDBUtility.ObjectEnum.DataSet);
                }
            }
        }
        #endregion
        ...
        public DataSet GetFieldName_and_LabelPharmacy(int FeatureId, int PatientId)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@password", SqlDbType.VarChar, ApplicationAccess.DBSecurity);
                ClsObject FieldMgr = new ClsObject();
                return (DataSet)FieldMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPatientPharmacyCustomFormFieldLabel_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        #endregion
        ...
        public DataSet GetPmtctDecodeTable(string CodeID)
        {
            lock (this)
            {
                ...
                //ClsUtility.AddParameters("@password", SqlDbType.VarChar, ApplicationAccess.DBSecurity);
                ClsObject FieldMgr = new ClsObject();
                return (DataSet)FieldMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPmtctDeCode_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public DataSet SaveUpdate(String Insert, DataSet DS, int TabId)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < DS.Tables[0].Rows.Count; i++)
                {
                    ...
                    int retvaldisclose = (Int32)CustomMgrSave.ReturnObject(ClsUtility.theParams, "pr_Clinical_SaveCustomFormLabPharmacyRegimen_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
        ...
        public int GetCustomFormSavedByUser(int FeatureId, int TabID)
        {
            lock (this)
            {
                ...
                DataTable dtTmp = (DataTable)FieldMgr.ReturnObject(ClsUtility.theParams, "pr_CustomFormSavedByUser", ClsDBUtility.ObjectEnum.DataTable);
