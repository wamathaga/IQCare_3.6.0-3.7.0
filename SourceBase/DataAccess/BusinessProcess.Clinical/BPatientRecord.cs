    ...
    public class BPatientRecord : ProcessBase, IPatientRecord
    {
        public DataSet GetPatientRecord(string Mode, int Ptn_Pk, int LocationID, int VisitId)
        {
            lock (this)
            {
                ...
                return (DataSet)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPatientRecordCTC_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataTable SavePatientRecord(Hashtable ht, Array arrIllness, Array arrReferredTo, Array arrAdhReason, Array arrARVReason4, DataTable theCustomFieldData)
        {
            ...
            try
            {
                ...
                dtresult = (DataTable)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_SavePatientRecordCTC_Constella", ClsDBUtility.ObjectEnum.DataTable);
                ...
                for (int i = 0; i < arrIllness.Length; i++)
                {
                    ...
                    retval = (int)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_SavePatientRecordIllnessCTC_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                ...
                for (int i = 0; i < arrReferredTo.Length; i++)
                {
                    ...
                    retval = (int)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_SavePatientRecordReferredToCTC_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                ...
                for (int i = 0; i < arrAdhReason.Length; i++)
                {
                    ...
                    retval = (int)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_SavePatientRecordAdhReasonCTC_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                ...
                for (int i = 0; i < arrARVReason4.Length; i++)
                {
                    ...
                    retval = (int)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_SavePatientRecordARVReasonChangeCTC_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                ...
                //        theRowAffected = (int)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_General_Dynamic_Insert", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                for (Int32 i = 0; i < theCustomFieldData.Rows.Count; i++)
                {
                   ClsUtility.Init_Hashtable();
                    ...
                    int RowsAffected = (Int32)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_General_Dynamic_Insert", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
        ...
        public int DeletePatientRecord(string FormName, int OrderNo, int PatientId, int UserID)
        {
            ...
            try
            {
                ...
                theAffectedRows = (int)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_DeletePatientForms_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public DataSet CheckVisitDate(string Ptn_Pk, int LocationID, DateTime VisitDate, int VisitId)
        {
            lock (this)
            {
                ...
                return (DataSet)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_CheckVisitDatePatientRecordCTC_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetCD4TLC(Hashtable htCD4TLC)
        {
            lock (this)
            {
                ...
                ClsObject PatientRecord = new ClsObject();
                return (DataSet)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetCD4TLCPatientRecordCTC_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetHeightCD4Regimen(string Ptn_Pk,string VisitId,string VisitDate,string LocationID)
        {
            lock (this)
            {
                ...
                ClsObject PatientRecord = new ClsObject();
                return (DataSet)PatientRecord.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetHeightCD4RegimenARVStatusCTC_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
    }
}
