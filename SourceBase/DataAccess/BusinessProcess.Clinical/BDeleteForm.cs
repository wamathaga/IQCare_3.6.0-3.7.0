       ...
       #region "Constuctor"
        ...
        public DataSet GetPatientForms(int PatientId)
        {
            lock (this)
            {
                ...
                //return (DataSet)PatientGetForm.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPatientForms_Constella", ClsDBUtility.ObjectEnum.DataSet);

                return (DataSet)PatientGetForm.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPatientHistory_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
       ...
       public int DeletePatientForms(DataTable theDT, int PatientId)
       {
           ...
           try
           {
               ...
               for (int i = 0; i < theDT.Rows.Count; i++)
               {
                   ...
                   theAffectedRows = (int)PatientDeleteForm.ReturnObject(ClsUtility.theParams, "pr_Clinical_DeletePatientForms_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
               }
