    ...
    public class BNonARTFollowUp : ProcessBase, INonARTFollowUp
    {
        ...
        public DataSet GetPatientNonARTFollowUp(int PatientID)
        {
            lock (this)
            {
                ...
                return (DataSet)NonARTManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetNonARTFollowup_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public DataSet GetExistVisitNonARTFollowUp(int PatientID)
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@PatientId", SqlDbType.Int, PatientID.ToString());
                return (DataSet)NonARTManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetExisitNonARTFollowupVisit_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetPatientExsistNonARTFollowUp(int PatientID, int VisitID)
        {
            lock (this)
            {
                ...
                return (DataSet)NonARTManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetNonARTFollowUpUpdate_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetExistNonARTFollowUpDrugDetails(int PharmacyID)
        {
            lock (this)
            {
                ...
                return (DataSet)NonARTManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetExistNonARTFollowUpPharmacyDetails", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public DataSet GetExistNonARTFollowUpDetails(int PharmacyID, int VisitID, int PateintID)
        {
            lock (this)
            {
                ...
                return (DataSet)NonARTManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetExistNonARTFollowUpDetails", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public DataSet GetNonARTBoundaryValues()
        {
            lock (this)
            {
                ClsObject NonARTManager = new ClsObject();
                ClsUtility.Init_Hashtable();
                return (DataSet)NonARTManager.ReturnObject(ClsUtility.theParams, "pr_Laboratory_GetLabValues_constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public int DeleteNonARTForms(string FormName, int OrderNo, int PatientId, int UserID)
        {
            ...
            try
            {
                ...
                theAffectedRows = (int)DeleteNonARTForm.ReturnObject(ClsUtility.theParams, "pr_Clinical_DeletePatientForms_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
