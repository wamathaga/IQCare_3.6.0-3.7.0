    ...
    public class BFollowup : ProcessBase, IFollowup
    {
        ...
        public DataTable GetPatient_No_Of_IE(int patientid)
        {
            lock (this)
            {
                ...
                return (DataTable)IEManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPatient_No_of_ARTFU_Constella", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public DataSet GetPatient_No_Of_VisitDate(int patientid, string visitdate, int visittype)
        {
            lock (this)
            {
                ClsUtility.Init_Hashtable();
        ...
        public DataSet GetLatestCD4ViralLoad(int patientid, DateTime visitdate)
        {
            lock (this)
            {
                ...
                ClsObject UserManager = new ClsObject();
                return (DataSet)UserManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetCD4ViralLoad_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetLatestHeight(int patientid, DateTime visitdate)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@visitdate", SqlDbType.VarChar, visitdate.ToString("dd-MMM-yyyy"));
                ClsObject UserManager = new ClsObject();
                return (DataSet)UserManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetPatientHeight_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        //Dropdown Lists
        public DataSet GetAllDropDownsART(int patientid)
        {
            lock (this)
            {
                ...
                return (DataSet)FUARTManager.ReturnObject(ClsUtility.theParams, "pr_Admin_GetFollowupARTDropDowns_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        //Saving and Updating
        ...
        public DataSet GetFollowUpARTupdate(int patientID, int VisitID, int LocationID)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@LocationID", SqlDbType.Int, LocationID.ToString());
                ClsObject UserManager = new ClsObject();
                return (DataSet)UserManager.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetFollowUpARTUpdate_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public int DeleteARTForms(string FormName, int OrderNo, int PatientId, int UserID)
        {
            try
            {
                ...
                theAffectedRows = (int)DeleteARTForm.ReturnObject(ClsUtility.theParams, "pr_Clinical_DeletePatientForms_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
