    ...
    public class BPatientTransfer : ProcessBase, IPatientTransfer
    {
        ...
        public DataSet GetLatestTransferDate(int PatientId, int VisitID)
        {
            lock (this)
            {
                ...
                return (DataSet)TransferDateMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetTopTransferDate_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataTable GetSatelliteID(string PatientId)
        {
            lock (this)
            {
                ...
                return (DataTable)TransferMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_PatientSatellite_LocationID", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public DataSet GetDataValidate(string PatientId, string transferdate)
        {
            lock (this)
            {
                ...
                return (DataSet)TransferMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_PatientSatelliteDataValidate_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetDateValidateBetween(string PatientId, string Existingdate)
        {
            lock (this)
            {
                ...
                return (DataSet)TransferMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_PatientSatelliteDateBetween_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetSatelliteLocation(string PatientId, string TransferId, int Flag, string SystemID)
        {
            lock (this)
            {
                ...
                return (DataSet)TransferMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_PatientSatelliteDetails_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public int SaveUpdate(string ID, string PatientId, string TransferfromId, string TransfertoId, string TransfertoDate, int userId, string createdate, int flag)
        {
            ...
            try
            {
                ...
                ClsUtility.AddParameters("@Flag", SqlDbType.Int, flag.ToString());
                int RowsAffected = (Int32)SaveUpdateMgr.ReturnObject(ClsUtility.theParams, "pr_Clinical_PatientSatelliteTransferSaveUpdate_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                if (RowsAffected == 0)
                {
