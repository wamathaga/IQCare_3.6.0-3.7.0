...
namespace BusinessProcess.Clinical
{
    public class BPatientRegistration : ProcessBase, IPatientRegistration
    {
        ...
        ////////        ClsUtility.AddParameters("@UserID", SqlDbType.Int, ht["UserID"].ToString());
        ////////        ClsUtility.AddParameters("@Password", SqlDbType.VarChar, ApplicationAccess.DBSecurity);
        ////////        int RowsAffected = (Int32)PatientManager.ReturnObject(ClsUtility.theParams, "Pr_Clinical_UpdateEnrollment_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ////////        if (RowsAffected == 0)
        ////////        {
        ...
        public DataSet GetModuleNames(int FacilityID, int UserId)
        {
            lock (this)
            {
                ...
                ClsObject UserManager = new ClsObject();
                return (DataSet)UserManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SelectModulesByUserIDFacilityID_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
            ...
            int MaxRecords = 100)
        {
            ...
            lock (this)
            {
                ...
                ClsObject UserManager = new ClsObject();
                return (DataTable)UserManager.ReturnObject(ClsUtility.theParams, "dbo.Pr_Clinical_GetPatientSearchresults", ClsDBUtility.ObjectEnum.DataTable);
