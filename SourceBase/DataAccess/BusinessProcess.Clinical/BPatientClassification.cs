    ...
    public class BPatientClassification : ProcessBase, IPatientClassification
    {
        public DataTable SaveUpdatePatientClassification(int Ptn_pk, int LocationID, int Visit_pk, int ARTSponsorID, int UserId, DateTime DateEffective, int DeleteFlag)  
       {
           ...
           try
           {
               ...
               DataTable DT = (DataTable)PatientClassification.ReturnObject(ClsUtility.theParams, "Pr_Clinical_SavePatientClassification_Constella", ClsDBUtility.ObjectEnum.DataTable);
        ...
        public int DeletePatientClassification(int Ptn_pk, int ARTSponsorID, DateTime DateEffective)
        {
            try
            {
                ...
                ClsUtility.AddParameters("@ARTSponsorID", SqlDbType.Int, ARTSponsorID.ToString());
                ClsUtility.AddParameters("@VisitDate", SqlDbType.DateTime, DateEffective.ToString());
                theAffectedRows = (int)DeletePatientClassification.ReturnObject(ClsUtility.theParams, "Pr_Clinical_DeletePatientClassification_Constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public DataSet GetClassification(int SystemId)
        {
            lock (this)
            {
                ...
                ClsObject PatientClassification = new ClsObject();
                return (DataSet)PatientClassification.ReturnObject(ClsUtility.theParams, "pr_clinical_GetClassification_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetAllPatientClassificationData(int PatientId)
        {
            lock (this)
            {
                ...
                //ClsUtility.AddParameters("@LocationID", SqlDbType.Int, LocationID.ToString());
                ClsObject PatientClassification = new ClsObject();
                return (DataSet)PatientClassification.ReturnObject(ClsUtility.theParams, "pr_Clinical_GetAllPatientClassificationData_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
