    ...
    public class BHomePageConfiguration : ProcessBase, IHomePageConfiguration
    {
        public DataSet GetHomePageIndicatorQuery(int ModuleId, int Published)
        {
            lock (this)
            {
                ...
                return (DataSet)QueryIndicater.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_GetHomePageIndicatorQuery_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public DataSet GetTechnicalArea()
        {
            lock (this)
            {
                ...
                ClsUtility.Init_Hashtable();
                return (DataSet)TechArea.ReturnObject(ClsUtility.theParams, "pr_FormBuilder_GetMasters_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetIndicatorQueryResult(int FeatureId)
        {
            lock (this)
            {
                ...
                return (DataSet)SearchIndicator.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_GetIndicatorQueryResult_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public int DeleteIndicator(int ID, int flag)
        {
            lock (this)
            {
                ...
                theRowAffected = (int)CustomField.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_DeleteIndicator_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                if (theRowAffected == 0)
                {
        ...
        public String ParseSQLStatement(string sqlstr)
        {
            lock (this)
            {
                try
                {
                    ...
                    DataTable dt1 = (DataTable)Query.ReturnObject(ClsUtility.theParams, "pr_General_SQL_Parse", ClsDBUtility.ObjectEnum.DataTable);
        ...
        public int SaveHomePageIndicator(DataSet dsSaveIndicatorQuery, string Flag)
        {
            ...
            try
            {
                ...
                theDR = (DataRow)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SaveFeature_Futures", ClsDBUtility.ObjectEnum.DataRow);
                ...
                theDR = (DataRow)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SaveHomePageIndicatorQuery_Futures", ClsDBUtility.ObjectEnum.DataRow);
                ...
                for (int i = 0; i <= dsSaveIndicatorQuery.Tables[0].Rows.Count - 1; i++)
                {
                   ...
                   if (Flag == "U")
                    ...
                    else
                    {
                        ...
                        theRowAffected = (int)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SavedtlHomePageIndicatorQuery_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                DataMgr.CommitTransaction(this.Transaction);
                DataMgr.ReleaseConnection(this.Connection);
