    ...
    public class BManageForms : ProcessBase, IManageForms
    {
        public DataSet GetPublishedModuleList()
        {
            lock (this)
            {
                ...
                return (DataSet)BusinessRule.ReturnObject(ClsUtility.theParams, "pr_FormBuilder_GetPublishedModuleList_Constella", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetFormDetail(string strFormStatus, Int32 CountryId)
        {
            lock (this)
            {
                ...
                return (DataSet)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_ManageForm_GetPatientRegistrationFormDetail_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet GetPharmacyFormDetail(string strFormStatus, Int32 CountryId)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@FormStatus", SqlDbType.VarChar, strFormStatus);
                ClsUtility.AddParameters("@CountryId", SqlDbType.VarChar, CountryId.ToString());
                return (DataSet)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_ManageForm_GetPatientPharmacyFormDetail_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public DataSet CheckFormDetail(string strFormName,Int32 iFormId)
        {
            lock (this)
            {
                ...
                return (DataSet)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_ManageForm_CheckFormDetail_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public void DeleteFormTableDetail(string strFormName,Int32 iFormId)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@FormName", SqlDbType.VarChar, strFormName);
                ClsUtility.AddParameters("@FormId", SqlDbType.VarChar, iFormId.ToString());
                FormDetail.ReturnObject(ClsUtility.theParams, "Pr_ManageForm_DeleteFormTableDetail_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
            }
         }
        public int ResetFormStatus(Int32 iFormId, string strValue, Int32 iUserID)
        {
            lock (this)
            {
                ...
                theRowAffected = (int)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_ManageForm_ResetFormStatus_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                if (theRowAffected == 0)
                {
