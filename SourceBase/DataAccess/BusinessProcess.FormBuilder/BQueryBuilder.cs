    ...
    public class BQueryBuilder:ProcessBase,IQueryBuilder
    {
        ...
        public DataTable SaveCustomReport(Int32 ReportId,Int32 CategoryId,string CategoryName,string ReportName, string ReportQuery,Int32 UserId)
        {
            lock (this)
            {
                ...
                return (DataTable)theQB.ReturnObject(ClsUtility.theParams, "pr_SaveCustomReports_Futures", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public DataSet ExportReport(int ReportId)
        {
            lock (this)
            {
                ...
                ClsObject theQB = new ClsObject();
                ClsUtility.AddParameters("@ReportId", SqlDbType.Int, ReportId.ToString());
                return (DataSet)theQB.ReturnObject(ClsUtility.theParams, "pr_Reports_QueryBuilderExport_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        //QueryBuilder Report
        ...
        public int SaveUpdateQueryBuilderReport(DataSet dsReportDetails,Int32 theUserId)
        {
            lock (this)
            {
                ...
                int theRowAffected = (int)QueryBuilderReport.ReturnObject(ClsUtility.theParams, "pr_QueryBuilderReportSaveUpdate_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
