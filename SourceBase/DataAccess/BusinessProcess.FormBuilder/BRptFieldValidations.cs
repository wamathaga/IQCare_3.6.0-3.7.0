     ...
     public class BRptFieldValidations : ProcessBase, IRptFieldValidations
    {
         public DataSet GetRptFieldDetails()
        {
            lock (this)
            {
                ...
                return (DataSet)RptField.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_GetCareEndedForm_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
         ...
         public DataTable ParseXml(string stringxml,int FacilityId,int ModuleId)
         {
             lock (this)
             {
                 ...
                 return (DataTable)theQB.ReturnObject(ClsUtility.theParams, "pr_General_ProcessXml", ClsDBUtility.ObjectEnum.DataTable);
             }
         }
