    ...
    public class BImportExport:ProcessBase,IImportExport
    {
        ...
        public DataTable ExportIQCareDB(Int32 LocationId, DateTime FromDate, DateTime ToDate)
        {
            lock (this)
            {
                try
                {
                    ...
                    theExportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_CreateExportDB_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                    ...
                    DataTable theDT = (DataTable)theExportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_ExportDataDump_Futures", ClsDBUtility.ObjectEnum.DataTable);
                    return theDT;
                }
                catch (Exception err)
                {
            ...
            try
            {
                ...
                if (TableName == "Costallocationcategory" || TableName == "Adjustmentreason" || TableName == "Returnreason" || TableName == "Labtestlocation")
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        Int32 NoRowsEffected = (Int32)ExportMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_SCMMasterDecodeTableImport", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                if (TableName == "ItemConfiguration")
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        Int32 NoRowsEffected = (Int32)ExportMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_SCMExportItemDrugType", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                if (TableName == "Programitemlinking")
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        Int32 NoRowsEffected = (Int32)ExportMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_SCMExportProgramItem", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                if (TableName == "Storeitemlinking")
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        Int32 NoRowsEffected = (Int32)ExportMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_SCMExportStoreItem", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                if (TableName == "Supplieritemlinking")
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        Int32 NoRowsEffected = (Int32)ExportMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_SCMExportSupplierItem", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                {
                    ClsUtility.Init_Hashtable();
                    ExportMgr.ReturnObject(ClsUtility.theParams, "pr_Admin_SCM_AddConstraint", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
        ...
        public void ImportIQCareData(Int32 LocationId, string theFileName)
        {
            try
            {
                ...
                theImportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_CreateExportDB_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);

                ///Restore DB-Cannot be in Transaction Mode///
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@FileName", SqlDbType.VarChar, theFileName);
                theImportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_RestoreImportIQCareData_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                ClsUtility.Init_Hashtable();
                ClsUtility.AddParameters("@Password", SqlDbType.VarChar, ApplicationAccess.DBSecurity.ToString());
                theImportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_ImportIQCareData_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);

                theImportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_ImportIQCareCustomFormData_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);

                theImportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_ImportIQCareTransactionData_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);

                ClsUtility.Init_Hashtable();
                theImportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_ImportIQCareSupportData_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);

                DataMgr.CommitTransaction(this.Transaction);

                ///Drop DB-Cannot be in Transaction Mode///
                ClsUtility.Init_Hashtable();
                theImportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_DropIQExportDB_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                DataMgr.ReleaseConnection(this.Connection);
        ...
        public DataSet ExportSCMIQCare()
        {
            lock (this)
            {
                try
                {
                    ClsUtility.Init_Hashtable();
                    ClsObject theExportManager = new ClsObject();
                    DataSet theDs = (DataSet)theExportManager.ReturnObject(ClsUtility.theParams, "Pr_Admin_SCMExportData_Futures", ClsDBUtility.ObjectEnum.DataSet);
                    return theDs;
                }
                catch (Exception err)
                {
        ...
        public void DBBackUpImportData()
        {
            lock (this)
            {
                try
                {
                    ClsUtility.Init_Hashtable();
                    ClsObject theExportManager = new ClsObject();
                    theExportManager.ReturnObject(ClsUtility.theParams, "pr_Admin_SCMImportDBBackup", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
