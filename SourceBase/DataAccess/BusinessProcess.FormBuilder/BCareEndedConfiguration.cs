    ...
    public class BCareEndedConfiguration : ProcessBase, ICareEndedConfiguration
    {
        public DataSet GetCareEndedDetails()
        {
            lock (this)
            {
                ...
                return (DataSet)CareEnd.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_GetCareEndedForm_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetCareEndQuery(int ModuleId, int Published)
        {
            lock (this)
            {
                ...
                return (DataSet)QueryIndicater.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_GetCareEndedFormDetails_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        ...
        public DataSet GetCareEndedInfo(int FeatureId)
        {
            lock (this)
            {
                ...
                return (DataSet)CareEnded.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_GetCareEndedInfo_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
        public DataTable SaveNewPatientExitReason(string theExitReason, Int32 theUserId, int theSystemId)
        {
            lock (this)
            {
                ...
                return (DataTable)CareEnded.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SaveExitReason_Futures", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        public int StatusUpdate(Hashtable ht)
        {
            ...
            try
            {
                ...
                RowsEffected = (Int32)ModuleMgr.ReturnObject(ClsUtility.theParams, "pr_Security_UpdateStatus_constella", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public int SaveCareEndDetails(DataSet dsCareEndDetail, Int32 FeatureId, string FeatureName, String SectionName, Int32 ModuleId, Int32 UserId, String CountryId, Int32 SectionId, DataTable dtconditionalFields, DataTable theDeathReason, int FacilityId)
        {
            try
            {
                this.Connection = DataMgr.GetConnection();
                ...
                theDR = (DataRow)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SaveCareEndFeature_Futures", ClsDBUtility.ObjectEnum.DataRow);
                ...
                for (int i = 0; i <= dsCareEndDetail.Tables[1].Rows.Count - 1; i++)
                {
                    ...
                    theRowAffected = (int)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SavelnkProgramExitReason_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                ...
                for (int i = 0; i <= dsCareEndDetail.Tables[0].Rows.Count-1; i++)
                {
                    ...
                    theRowAffected = (int)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SaveCareEndLnkForms_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                for (int i = 0; i <= dsCareEndDetail.Tables[2].Rows.Count - 1; i++)
                {
                    ...
                    theRowAffected = (int)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SaveLnkCareEndForm_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                ...
                foreach (DataRow theDRCon in dtconditionalFields.Rows)
                {
                    ...
                    theRowAffected = (int)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_Savelnk_CareEndConditionalFields_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
                ...
                for (int i = 0; i <= theDeathReason.Rows.Count - 1; i++)
                {
                    ...
                    if (i == 0)
                        ClsUtility.AddParameters("@SaveFlag", SqlDbType.Int, "1");
                    theRowAffected = (int)FormDetail.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SavelnkModuleDeathReason_Futures", ClsDBUtility.ObjectEnum.ExecuteNonQuery);
                }
        ...
        public DataTable SaveNewPatientDeathReason(string theDeathReason, Int32 theUserId, int theSystemId)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@UserId", SqlDbType.Int, theUserId.ToString());
                ClsUtility.AddParameters("@SystemId", SqlDbType.Int, theSystemId.ToString());
                return (DataTable)CareEnded.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_SaveDeathReason_Futures", ClsDBUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public DataSet GetCareendConditionalFieldsDetails(Int32 ConfieldID, Int32 FeatureID)
        {
            lock (this)
            {
                ...
                ClsUtility.AddParameters("@FeatureId", SqlDbType.Int, FeatureID.ToString());
                return (DataSet)CustomField.ReturnObject(ClsUtility.theParams, "Pr_FormBuilder_GetCareendConditionalFields_Futures", ClsDBUtility.ObjectEnum.DataSet);
            }
        }
