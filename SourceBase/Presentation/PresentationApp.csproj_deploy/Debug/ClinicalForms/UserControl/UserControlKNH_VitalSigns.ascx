                    ...
                    <td class="form center" valign="middle">
                        <table width="100%">
                            <tr>
                                ...
                                <td width="25%" align="center" id="tdBPDP">
...
&nbsp;<asp:TextBox ID="txtBPSystolic" runat="server" Width="35px"></asp:TextBox>
                    ...
                    <td class="form" align="center" valign="middle">
                        <table width="100%">
                            <tr>
                                ...
                                <td width="33%" align="center" id="tdBMI">
                                    <label class="margin5">
                                        BMI:</label>
                ...
                <tr>
                    <td id="divshowvitalsign" class="form" align="center" valign="middle">
                        <table width="100%">
                                <tr>
                                    <td align="center" width="25%" id="tdHC">
                                        <label id="Label1">
                                    ...
                                    <td valign="middle" align="center" width="25%" id="tdBMIZscore">      
                                    <table>
                                    <tr>
                                    <td>
