<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="true"
    Inherits="ClinicalForms_frmClinical_EnrolmentPMTCT" Title="Untitled Page" EnableViewState="true"
    CodeBehind="frmClinical_EnrolmentPMTCT.aspx.cs" %>
                                ...
                                <tr>
                                    <td style="width: 550px" class="border pad5 whitebg" nowrap>
                                        ...
                                        <img onclick="w_displayDatePicker('<%=TxtDOB.ClientID %>');" height="22" alt="Date Helper"
                                            hspace="3" src="../images/cal_icon.gif" width="20" border="0" style="vertical-align: bottom; margin-bottom: 2px;"/>
                                        <span class="smallerlabel">DD-MMM-YYYY </span>
