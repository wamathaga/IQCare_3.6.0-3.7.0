                                                            ...
                                                            <table width="40%" cellpadding="5px" cellspacing="5px">
                                                                <tr>
                                                                    <td colspan="4">
                                                                        <label class="right30">
                                                                            Default Doses :
                                                                        </label><span class="smallerlabel" id="Span2">These will populate dosing fields on pharmacy dispense</span>
                                                                        <tr>
                                                                            <td style="width: 50px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    ...
                                                                    <img id="appDateimg2" height="22" runat="server" alt="Date Helper" hspace="5" src="../images/cal_icon.gif"
                                                                        width="22" border="0" name="appDateimg" onclick="w_displayDatePicker('ctl00_IQCareContentPlaceHolder_tabControl_TabPanel3_txtEffectiveDate');" />
