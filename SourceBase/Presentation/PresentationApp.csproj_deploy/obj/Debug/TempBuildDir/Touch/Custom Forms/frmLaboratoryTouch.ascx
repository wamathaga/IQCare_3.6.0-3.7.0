...
<div id="FormContent">
       <script type="text/javascript">
           function clickLoading() {
               var btn = document.getElementById('btnInvisShowLoading');
               btn.click();
           }
</script>
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" NoMasterRecordsText="No Records Found"
                                        ...
                                        <Columns>
                                           ...
                                           <HeaderStyle Width="100px" />
                                            ...
                                            <telerik:GridButtonColumn  UniqueName="ResultsButton" Text="Results" CommandName="Select" ButtonType="LinkButton"  HeaderText="Next Action" /> 
