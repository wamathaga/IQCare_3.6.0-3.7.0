<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IQCare.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="frmFindPatient.aspx.cs" Inherits="IQCare.Web.Billing.frmFindPatient" %>
  <%@ MasterType VirtualPath="~/MasterPage/IQCare.master" %>
<%@ Register src="../PatientFinder.ascx" tagname="PatientFinder" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="server">

    <uc1:PatientFinder ID="FindPatient" runat="server"  FilterByServiceLines="False" IncludeEnrollement="False"  AutoLoadRecords="False" NumberofRecords="50" CanAddPatient="False"/>
