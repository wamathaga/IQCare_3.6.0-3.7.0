...
{
    public partial class PatientWardAdmission : System.Web.UI.UserControl
    {
...
//                });";
        ...
        protected void buttonAdmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (textBedNumber.Text.Trim() =="") throw new Exception("Bed number cannot be blank");
                ...
                if (dateAdmitted > DateTime.Now) throw new Exception("Admission date cannot be greater than today");
        ...
        protected void buttonCancelAddWard_Click(object sender, EventArgs e)
        {
            labelAvailablity.Text = "";
        }
    }
}