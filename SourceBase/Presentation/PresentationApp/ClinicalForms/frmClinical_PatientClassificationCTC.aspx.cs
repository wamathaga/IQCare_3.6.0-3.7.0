...
public partial class frmClinical_PatientClassificationCTC : BasePage
{
   ...
   private void Refresh()
    ...
    private void SaveCancel()
    {
        ...
        script += "else \n";
        script += "{\n";
        script += "window.location.href='../ClinicalForms/frmClinical_PatientClassificationCTC.aspx?name=Edit';\n";
        script += "}\n";
        script += "</script>\n";
