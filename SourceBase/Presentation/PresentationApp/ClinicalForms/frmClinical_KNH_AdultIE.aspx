...
<%@ Register src="UserControl/UserControlKNH_BackToTop.ascx" tagname="UserControlKNH_BackToTop" tagprefix="uc1" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='width: 40%' align='left'>
                                                        <asp:RadioButtonList ID="rblDiagnosisYesNo" runat="server" onclick="rblSelectedValue(this,'DIVHIVDiagnosis');"
                                                            RepeatDirection="Horizontal"><asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                                ...
                                                <table width='100%'>
                                                    <tr>
                                                        ...
                                                        <td style='width: 50%' align='left'>
                                                            <input ID="txtdtConfirmHIVPosDate" runat="server" maxlength="11" 
                                                            ...
                                                            <img ID="Img1" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                                name="appDateimg" 
                                                                onclick="w_displayDatePicker('<%=txtdtConfirmHIVPosDate.ClientID%>');" 
                                                                src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='width: 40%' align='left'>
                                                        <asp:RadioButtonList ID="rblChildAccompaniedBy" runat="server" RepeatDirection="Horizontal"
                                                            OnClick="rblSelectedValue(this,'divTreatmentSupporterRelationship')"><asp:ListItem Text="Yes" Value="1"></asp:ListItem>
<asp:ListItem Text="No" Value="0"></asp:ListItem>
</asp:RadioButtonList>
                                        ...
                                        <td style='width: 50%'>
                                            <table width='100%' id="divTreatmentSupporterRelationship" style="display: none;">
                                                <tr>
                                                    ...
                                                    <td style='width: 50%' align='left'>
                                                        <asp:DropDownList ID="ddlTreatmentSupporterRelationship" runat="server" Width="130px"></asp:DropDownList>
                                        ...
                                        <td class='border pad5 whitebg' align="center" colspan="2">
                                            <table width='100%'>
                                                <tr>
                                                    ...
                                                    <td style='width: 50%' align='left'>
                                                        <asp:RadioButtonList ID="rdoHealthEducation" runat="server" RepeatDirection="Horizontal"><asp:ListItem Text="Yes" Value="1"></asp:ListItem>
<asp:ListItem Text="No" Value="0"></asp:ListItem>
</asp:RadioButtonList>
                                        ...
                                        <td style='width: 50%' colspan="2">
                                            <table width='100%'>
                                                <tr>
                                                    ...
                                                    <td style='width: 40%' align='left'>
                                                        <asp:DropDownList ID="ddlDisclosureStatus" runat="server" Width="130px"></asp:DropDownList>
                                            ...
                                            <div id="divSpecifyreason" style="display: none;">
                                                <table width='100%'>
                                                    <tr>
                                                        ...
                                                        <td style='width: 50%' align='left'>
                                                            <asp:DropDownList ID="ddreasondisclosed" runat="server" Width="130px"></asp:DropDownList>
                                        ...
                                        <td width="50%" colspan="2">
                                            <table width='100%'>
                                                <tr>
                                                    ...
                                                    <td style='width: 40%' align='left'>
                                                        <asp:DropDownList ID="ddlSchoolingStatus" runat="server" Width="130px"></asp:DropDownList>
                                            ...
                                            <div id="divHighestLevelattained" style="display: none">
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td style='width: 50%' align='left'>
                                                            <asp:DropDownList ID="ddHighestlevelattained" runat="server" Width="130px"></asp:DropDownList>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='width: 40%' align='left'>
                                                        <asp:RadioButtonList ID="rblHIVSupportgroup" runat="server" RepeatDirection="Horizontal"
                                                            onclick="rblSelectedValue(this,'DIVsupportgroup');"><asp:ListItem Text="Yes" Value="1"></asp:ListItem>
<asp:ListItem Text="No" Value="0"></asp:ListItem>
</asp:RadioButtonList>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td width="32%" align="left">
                                                        <asp:DropDownList ID="ddlPatientReferred" runat="server" Width="130px"></asp:DropDownList>
...
<ContentTemplate>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style='width: 60%' align='left'>
                                                        <input ID="dtInitialCD4Date" runat="server" maxlength="11" 
                                                            onblur="DateFormat(this,this.value,event,false,'3')" 
                                                            onfocus="javascript:vDateType='3'" 
                                                            onkeyup="DateFormat(this,this.value,event,false,'3')" size="11" type="text" />&nbsp; 
                                                        &nbsp; </input>
                                                        <img ID="Img3" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                            name="appDateimg" 
                                                            onclick="w_displayDatePicker('<%=dtInitialCD4Date.ClientID%>');" 
                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel" id="Span3">(DD-MMM-YYYY)</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td style='width: 50%'>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style='width: 60%' align='left'>
                                                        <input ID="dtHighestCD4Date" runat="server" maxlength="11" 
                                                            onblur="DateFormat(this,this.value,event,false,'3')" 
                                                            onfocus="javascript:vDateType='3'" 
                                                            onkeyup="DateFormat(this,this.value,event,false,'3')" size="11" type="text" />&nbsp; 
                                                        &nbsp; </input>
                                                        <img ID="Img23" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                            name="appDateimg" 
                                                            onclick="w_displayDatePicker('<%=dtHighestCD4Date.ClientID%>');" 
                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel" id="Span23">(DD-MMM-YYYY)</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td style='width: 50%'>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style='width: 60%' align='left'>
                                                        <input ID="dtCD4atARTinitiationDate" runat="server" maxlength="11" 
                                                            onblur="DateFormat(this,this.value,event,false,'3')" 
                                                            onfocus="javascript:vDateType='3'" 
                                                            onkeyup="DateFormat(this,this.value,event,false,'3')" size="11" type="text" />&nbsp; 
                                                        &nbsp; </input>
                                                        <img ID="Img24" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                            name="appDateimg" 
                                                            onclick="w_displayDatePicker('<%=dtCD4atARTinitiationDate.ClientID%>');" 
                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel" id="Span24">(DD-MMM-YYYY)</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td style='width: 50%'>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style='width: 60%' align='left'>
                                                        <input ID="dtMostRecentCD4Date" runat="server" maxlength="11" 
                                                            onblur="DateFormat(this,this.value,event,false,'3')" 
                                                            onfocus="javascript:vDateType='3'" 
                                                            onkeyup="DateFormat(this,this.value,event,false,'3')" size="11" type="text" />&nbsp; 
                                                        &nbsp; </input>
                                                        <img ID="Img25" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                            name="appDateimg" 
                                                            onclick="w_displayDatePicker('<%=dtMostRecentCD4Date.ClientID%>');" 
                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel" id="Span25">(DD-MMM-YYYY)</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td style='width: 50%'>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style='width: 50%' align='left'>
                                                        <input ID="dtPreviousViralLoadDate" runat="server" maxlength="11" 
                                                            onblur="DateFormat(this,this.value,event,false,'3')" 
                                                            onfocus="javascript:vDateType='3'" 
                                                            onkeyup="DateFormat(this,this.value,event,false,'3')" size="11" type="text" />&nbsp; 
                                                        &nbsp; </input>
                                                        <img ID="Img26" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                            name="appDateimg" 
                                                            onclick="w_displayDatePicker('<%=dtPreviousViralLoadDate.ClientID%>');" 
                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel" id="Span26">(DD-MMM-YYYY)</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td style='width: 50%'>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style='width: 50%' align='left'>
                                                        <input ID="dtPMTCTStartDate" runat="server" maxlength="11" 
                                                            onblur="DateFormat(this,this.value,event,false,'3')" 
                                                            onfocus="javascript:vDateType='3'" 
                                                            onkeyup="DateFormat(this,this.value,event,false,'3')" size="11" type="text" />&nbsp; 
                                                        &nbsp; </input>
                                                        <img ID="Img27" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                            name="appDateimg" 
                                                            onclick="w_displayDatePicker('<%=dtPMTCTStartDate.ClientID%>');" 
                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel" id="Span27">(DD-MMM-YYYY)</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td style='width: 50%'>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style='width: 50%' align='left'>
                                                        <input ID="dtPEP1StartDate" runat="server" maxlength="11" 
                                                            onblur="DateFormat(this,this.value,event,false,'3')" 
                                                            onfocus="javascript:vDateType='3'" 
                                                            onkeyup="DateFormat(this,this.value,event,false,'3')" size="11" type="text" />&nbsp; 
                                                        &nbsp; </input>
                                                        <img ID="Img28" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                            name="appDateimg" 
                                                            onclick="w_displayDatePicker('<%=dtPEP1StartDate.ClientID%>');" 
                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel" id="Span28">(DD-MMM-YYYY)</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td style='width: 50%'>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style='width: 50%' align='left'>
                                                        <input ID="dtHAART1StartDate" runat="server" maxlength="11" 
                                                            onblur="DateFormat(this,this.value,event,false,'3')" 
                                                            onfocus="javascript:vDateType='3'" 
                                                            onkeyup="DateFormat(this,this.value,event,false,'3')" size="11" type="text" />&nbsp; 
                                                        &nbsp; </input>
                                                        <img ID="Img29" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                            name="appDateimg" 
                                                            onclick="w_displayDatePicker('<%=dtHAART1StartDate.ClientID%>');" 
                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel" id="Span29">(DD-MMM-YYYY)</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <act:CollapsiblePanelExtender ID="CPELTM" runat="server" SuppressPostBack="True"
                            ...
                            ImageControlID="ImgLTM" Enabled="True">
                        </act:CollapsiblePanelExtender>
                        ...
                        <act:CollapsiblePanelExtender ID="CPEHIVRH1" runat="server" SuppressPostBack="True"
                            ...
                            ImageControlID="ImgRH" Enabled="True">
                        </act:CollapsiblePanelExtender>
                        <act:CollapsiblePanelExtender ID="CPARVExposure" runat="server" SuppressPostBack="True"
                            ...
                            Collapsed="True" ImageControlID="ImgARVExposure" Enabled="True">
                        </act:CollapsiblePanelExtender>
                                ...
                                <tr>
                                    <td colspan="2" align="left">
                                        <asp:Panel ID="pnlOITreatment" CssClass="border center formbg" runat="server" Style="padding: 6px">
                                            <h2 class="forms" align="left"><asp:ImageButton ID="imgOITreatment" ImageUrl="~/images/arrow-up.gif" runat="server" />
                                                OI Treatment
                                                </h2>
                                        </asp:Panel>
                                    </td>
