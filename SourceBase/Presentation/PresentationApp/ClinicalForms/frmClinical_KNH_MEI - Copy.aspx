            ...
            <act:TabContainer ID="tabControl" runat="server" ActiveTabIndex="0" Width="100%">
                ...
                <act:TabPanel ID="TabPnlTriage" runat="server" Font-Size="Large" HeaderText="Triage">
                    <ContentTemplate>
                                        ...
                                        <asp:Panel ID="pnl2VitalSigns" runat="server">
                                            <div id="VitalSigns" style="display: none">
                                                <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <UcVitalSign:Uc1 ID="UCVitalSign" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                        ...
                        <br />
                        <div class="border center formbg">
                            <table cellspacing="6" cellpadding="0" width="100%" border="0" runat="server">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1HTC" runat="server" onclick="fnsetCollapseState();" CssClass="border center formbg"
                                            ...
                                            <h5 class="forms" align="left">
                                                ...
                                                <asp:Label ID="lblMHT" runat="server" Text="Maternal HIV Testing section"></asp:Label></h5>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                                    ...
                                                                    <td style="width: 50%;">
                                                                        <label id="Label18" runat="server" class="margin5">
                                                                            ...
                                                                            <label for="rdofamilyinformationFilledYes">
                                                                                Yes</label>
                                                                            <input id="rdofamilyinformationFilledNo" type="radio" value="No" runat="server" name="familyinformationFilled" onclick="window.open('frmFamilyInformation.aspx');" />
                                                            ...
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 60%;" align="left">
                                                                        <label id="Label30" runat="server" class="margin20" style="vertical-align:top;">
                                                                            Comments - Additional notes?</label>
                                                                        <asp:TextBox ID="txtPreferedSiteDeliveryAdditionalnotes" runat="server" TextMode="MultiLine"
                                                                            Style="height: 95px; vertical-align: middle" Width="50%"></asp:TextBox>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 30%;">
                                                                        <label id="Label38" runat="server" class="margin5">
                                                                            Maturity :
                                                                            <%--<asp:TextBox ID="txtMaturityweeks" runat="server"></asp:TextBox>--%>
                                                                            <asp:DropDownList ID="ddlMaturityweeks" runat="server">
                                                                                <asp:ListItem Text=" " Value="-1"></asp:ListItem>
                                                                                <asp:ListItem Text="Pre-term" Value="0"></asp:ListItem>
                                                                                <asp:ListItem Text="Term" Value="1"></asp:ListItem>
                                                                                <asp:ListItem Text="Post-term" Value="2"></asp:ListItem>
                                                                            </asp:DropDownList>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1PreviousObstreticsHistory" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h5 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label41" runat="server" Text="Obstretic History"></asp:Label></h5>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                ...
                                                <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                <%--<td align="left" style="width: 5%;" colspan="3">
                                                            ...
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td align="left" style="width:40%;" colspan="3">
                                                                        <label id="Label90" runat="server" class="margin5">
                                                                            History of Chronic Illness:
                                                                            <div id="div6" class="customdivbordermultiselect">
                                                                                <asp:Panel ID="pnlHistoryChronicIllness" runat="server">
                                                                                </asp:Panel>
                                                                            </div>
                                                                        </label>
                                                        ...
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 30%;">
                                                                        <label id="Label8" runat="server" class="margin5" align="left" style="margin-left: 5px">
                                                                            History of Blood Transfusion:
                                                                            <input id="Radio1" type="radio" value="Yes" runat="server"
                                                                                name="HistoryBloodTransfusion" />
                                                                            <label for="rdoHistoryBloodTransfusionYes">
                                                                                Yes</label>
                                                                            <input id="Radio2" type="radio" value="No" runat="server" name="HistoryBloodTransfusion" />
                                                                            <label for="rdoHistoryBloodTransfusionNo">
                                                                                No</label>
                                                                        </label>
                                                                        <div id="div5" style="display: none">
                                                                            <label for="txtBloodTransfusion">
                                                                                Date
                                                                                <input id="Text1" onblur="DateFormat(this,this.value,event,false,3)"
                                                                                    onkeyup="DateFormat(this,this.value,event,false,3);" onfocus="javascript:vDateType='3'"
                                                                                    maxlength="11" size="11" runat="server" type="text" />
                                                                                </input><img id="Img7" onclick="w_displayDatePicker('<%=txtBloodTransfusiondt.ClientID%>');"
                                                                                    height="22 " alt="Date Helper" hspace="5" src="../images/cal_icon.gif" width="20"
                                                                                    border="0" name="appDateimg" style="vertical-align: text-bottom;" /><span class="smallerlabel"
                                                                                        id="Span7">(DD-MMM-YYYY)</span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    <td style="width: 30%;">
                                                                        <label id="Label48" runat="server" align="right">
                                                                            History Of Twins :
                                                                            <input id="Radio3" type="radio" value="Yes" runat="server" name="HistoryOfTwins" />
                                                                            <label for="rdoHistoryBloodTransfusionYes">
                                                                                Yes</label>
                                                                            <input id="Radio4" type="radio" value="No" runat="server" name="HistoryOfTwins" />
                                                                            <label for="rdoHistoryBloodTransfusionNo">
                                                                                No</label>
                                                                        </label>
                                                                    </td>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1ManagementHIVPositiveClientOtherFacility" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h5 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label73" runat="server" Text="Management of Known Positives"></asp:Label></h5>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                                    ...
                                                                    <td style="width: 30%;">
                                                                       <label id="Label85" runat="server">
                                                                        ...
                                                                        <div id="div26" class="customdivbordermultiselect">
                                                                            <asp:Panel ID="pnlHIVStatus1" runat="server">
                                                                            </asp:Panel>
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 35%;" align="left">
                                                                        <label id="Label84" runat="server" align="left">
                                                                            Additonal Notes:
                                                                            <asp:TextBox ID="txtAdditionalPWPNotes" runat="server" TextMode="SingleLine" Width="70%" Height="90px"></asp:TextBox>
                                                                        </label>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                        ...
                                        <asp:Panel ID="Pnl2TBScreening" runat="server">
                                            <div id="TBS" style="display: none">
                                                <span id="spTbassessment" style="display: none">
                                                    ...
                                                    <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                                        <tr>
                                                            <td class="border pad5 whitebg" style="width: 100%;">
                                                                <label id="Label89" runat="server" class="margin20">
