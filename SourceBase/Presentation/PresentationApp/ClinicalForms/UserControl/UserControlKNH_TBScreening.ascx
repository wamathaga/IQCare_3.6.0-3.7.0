                        ...
                        <table width="100%">
                            <tr>
                                <td width="20%" align="left">
                                    &nbsp;<asp:Label ID="lblSputumSmear" runat="server" Font-Bold="True" 
                                        Text="Sputum smear:"></asp:Label>
                                </td>
                                <td width="40%">
                                    <table width="100%">
                                        <tr>
                ...
                <tr id="Tr1">
                    <td class="form" align="center" style="width: 100%" colspan="2">
                        <table width="100%">
                            <tr>
                                <td width="20%" align="left">
                                    &nbsp;<asp:Label ID="lblGeneExpert" runat="server" Font-Bold="True" 
                                        Text="GeneExpert:"></asp:Label>
                                </td>
                                <td width="40%">
                                    <table width="100%">
                                        <tr>
                ...
                <tr id="Tr2">
                    <td class="form" align="center" style="width: 100%" colspan="2">
                        <table width="100%">
                            <tr>
                                <td width="20%" align="left">
                                    &nbsp;<asp:Label ID="lblSuptumDST" runat="server" Font-Bold="True" 
                                        Text="Sputum for DST:"></asp:Label>
                                </td>
                                <td width="40%">
                                    <table width="100%">
                                        <tr>
                ...
                <tr id="chestXRay">
                    <td class="form" align="center" style="width: 100%" colspan="2">
                        <table width="100%">
                            <tr>
                                <td width="20%" align="left">
                                    &nbsp;<asp:Label ID="lblChestXRay" runat="server" Font-Bold="True" 
                                        Text="Chest X-Ray:"></asp:Label>
                                </td>
                                <td width="40%">
                                    <table width="100%">
                                        <tr>
                ...
                <tr id="tissueBiopsy">
                    <td class="form" align="center" style="width: 100%" colspan="2">
                        <table width="100%">
                            <tr>
                                <td width="20%" align="left">
                                    &nbsp;<asp:Label ID="lblTissueBiopsy" runat="server" Font-Bold="True" 
                                        Text="Tissue Biopsy:"></asp:Label>
                                </td>
                                <td width="40%">
                                    <table width="100%">
                                        <tr>
        ...
        <table cellspacing="6" cellpadding="0" width="100%" border="0">
            <tr>
                <td align="center" class="form">
                    <asp:RadioButtonList ID="rdoLstIPT" runat="server" RepeatDirection="Horizontal" 
                        onselectedindexchanged="rdoLstIPT_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="50%">
                    <table width="100%">
                    <tr>
                        <td align="right"><label>Reason for declining IPT :</label></td>
                        <td align="left"><asp:DropDownList ID="ddlReasonDeclinedIPT" runat="server"></asp:DropDownList></td>
                    </tr>
                    </table>
