...
public partial class ClinicalForms_wucDebitNote : System.Web.UI.UserControl
{
    ...
    private void PrintDebitNote(int billid)
    {
        ...
        string theUrl = string.Format("{0}&SatelliteID={1}&CountryID={2}&PosID={3}&sts={4}", "../Reports/frmReport_PatientARVPickup.aspx?name=Add", Session["AppSatelliteId"], Session["AppCountryId"], Session["AppPosID"], "1");
        string theScript;
    ...
    protected void GridViewSummary_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        //Control lb = e.Row.FindControl("LinkButtonBillId") ;
        //if (lb != null)
        //{
