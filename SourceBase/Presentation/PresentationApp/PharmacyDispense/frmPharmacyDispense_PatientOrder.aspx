...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="server">
    <script type="text/javascript">
        ...
        function ValidateRequired() {
            ...
            if (document.getElementById('<%=txtDispenseDate.ClientID %>').disabled == false) {
                var D1 = new Date($("#<%=txtDispenseDate.ClientID%>").val());
                var D2 = new Date($("#<%=txtprescriptionDate.ClientID%>").val());
                if (D1 < D2) {
                    alert("Dispensed date cannot be less than Prescription date");
                    return false;
                }
            }
                        ...
                        <td colspan="2">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblregimenLine" runat="server" Font-Bold="True" Text="Regimen Line:" CssClass="required" style="visibility: hidden;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlregimenLine" runat="server" Width="225px" Height="16px" style="visibility: hidden;">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                                                                ...
                                                                <asp:GridView ID="gvDispenseDrugs" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Instructions" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
                                                                          ...
                                                                          <asp:TemplateField HeaderText="GenericAbbrevation" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
                                                                            <ItemTemplate>
