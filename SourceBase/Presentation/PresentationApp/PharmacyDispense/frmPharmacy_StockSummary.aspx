                                ...
                                <tr>
                                    ...
                                    <td align="right" width="34%">
                                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-primary"
                                            Height="30px" Width="20%" Style="text-align: left;" OnClick="Button4_Click" />
                                        ...
                                        <asp:Button ID="btnExportToExcel" runat="server" Text="Export to Excel" CssClass="btn btn-primary"
                                            Height="30px" Width="30%" Style="text-align: left;" OnClick="btnExportToExcel_Click" />
                                        <label class="glyphicon glyphicon-export" style="margin-left: -4%; margin-right: 1%;
                                            vertical-align: sub; color: #fff;">
                                        </label>
                                    </td>
                                </tr>
