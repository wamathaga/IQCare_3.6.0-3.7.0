<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="true" CodeBehind="frmPharmacy_StockManagement.aspx.cs" Inherits="PresentationApp.PharmacyDispense.frmPharmacy_StockManagement" %>
            ...
            <tr valign="top">
                <td class="data-control">
                    <table style="width: 100%">
                        <tr>
                            <td width="33%">
                                ...
                                &nbsp;<asp:DropDownList ID="ddlTransactionType" runat="server" Width="150px" 
                                    AutoPostBack="True" 
                                ...
                                <asp:RequiredFieldValidator ID="TransactionTypeRequiredValidator" runat="server" ErrorMessage="Required"
                             Display="Dynamic" ControlToValidate="ddlTransactionType" InitialValue="0" ></asp:RequiredFieldValidator>
                                </td>
                            <td width="33%">
                    ...
                    <%--<asp:Label ID="Label1" runat="server" Font-Bold="True" 
                            ...
                            <label id="lblSourceStore">Source Store</label>
                    &nbsp;<asp:DropDownList ID="ddlSourceStore" runat="server" 
                            onselectedindexchanged="ddlSourceStore_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                    ...
                    <div id="tblDestinationStore">
                            ...
                            Text="Destination Store:"></asp:Label>
                    
                    &nbsp;<asp:DropDownList ID="ddlDestinationStore" runat="server" Width="150px">
                                </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="destinationStoreRequiredValidator" runat="server" ErrorMessage="Required"
                             Display="Dynamic" ControlToValidate="ddlDestinationStore" InitialValue="0" ></asp:RequiredFieldValidator>
                    </div>
                    </td>
                    </tr>
                    </table>
            ...
            <tr valign="top">
                ...
                <div class="GridView whitebg" style="cursor: pointer;">
                                                ...
                                                <div class="rounded">
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtDrug" runat="server" Width="850px" AutoPostBack="True" 
                                                                    ontextchanged="txtDrug_TextChanged" Enabled="False" ></asp:TextBox>
                                                                <div id="divwidth"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <asp:GridView ID="grdStockMngt" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                        Width="100%" BorderWidth="0px"  CellPadding="0" CssClass="datatable" GridLines="None" DataKeyNames="Drug_Pk"
                                                                        onrowdatabound="grdStockMngt_RowDataBound" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Batch No" HeaderStyle-Width="90px">
                                <ItemTemplate>
                                    <span style="display:<%# ShowLabel() %>"><asp:Label ID="lblBatchNo" runat="server" Text='<%# Bind("BatchNo") %>'></asp:Label></span>
                                    <span style="display:<%# ShowTextBox() %>"><asp:TextBox ID="txtBatchNo" runat="server" Text='<%# Bind("BatchNo") %>' ></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Expiry Date" HeaderStyle-Width="90px">
                                <ItemTemplate>
                                  <span style="display:<%# ShowLabel() %>"><asp:Label ID="lblExpiryDate" runat="server" Text='<%# Bind("ExpiryDate") %>'  ></asp:Label></span>  
                                   <span style="display:<%# ShowTextBox() %>"> <asp:TextBox ID="txtExpiryDate" runat="server" Text='<%# Bind("ExpiryDate") %>' onkeyup="DateFormat(this,this.value,event,false,3);"  ></asp:TextBox> 
                                   <act:CalendarExtender ID="cal3" runat="server" TargetControlID="txtExpiryDate" Format="dd-MMM-yyyy" ></act:CalendarExtender></span>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Quantity" ControlStyle-Width="90px">
                                <ItemTemplate>
                                    ...
                                    <asp:RangeValidator ID="qtyRangeValidator" runat="server" ErrorMessage="Error" MinimumValue="1" MaximumValue="500000000" Enabled="false" 
                                        ControlToValidate="txtQuantity" Type="Double" Display="Dynamic"></asp:RangeValidator>
