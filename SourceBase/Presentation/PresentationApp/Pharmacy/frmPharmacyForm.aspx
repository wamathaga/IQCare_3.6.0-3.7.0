                                        ...
                                        <tr>
                                            <td style="width: 35%" align="center">
                                                <label class="right35" style="width: 5%">
                                                    Weight:</label>
                                                <asp:TextBox ID="txtWeight" MaxLength="5" runat="server" Width="70"></asp:TextBox>&nbsp;Kg
                                                <br /><label class="smalllabel" id="dtwt" runat="server" ></label>
                                            </td>
                                            <td style="width: 35%" align="center">
                                                <label class="right35" style="width: 7%">
                                                    Height:</label>
                                                <asp:TextBox ID="txtHeight" MaxLength="4" runat="server" Width="70"></asp:TextBox>&nbsp;cm
                                                <br /><label class="smalllabel" id="dtht" runat="server" ></label>
                                            </td>
                                            <td style="width: 30%" align="center">
                                                <label class="patientInfo">
                                                    Body Surface Area:</label>
                                                <asp:Label ID="lblBSA" runat="server" Text=""></asp:Label>
                                                <asp:TextBox ID="txtBSA" runat="server" Width="70" />&nbsp;m<sup>2</sup>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
