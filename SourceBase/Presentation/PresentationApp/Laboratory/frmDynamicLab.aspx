<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="true"
    CodeBehind="frmDynamicLab.aspx.cs" Inherits="PresentationApp.Laboratory.frmDynamicLab" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function Close() {
            ...
            if (w == null || w.closed) {
                window.location = rurl + "/ClinicalForms/frmPatient_History.aspx";
            }
            else {
                window.close();
            }
    ...
    <div class="center" style="padding: 8px;">
        ...
        <div class="border center pad5 formbg" id="maindiv" runat="server">
        </div>
        <br />
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="pad5 center" colspan="2">
                            ...
                            <asp:Button ID="btnCancel" runat="server" Text="Back" OnClientClick="return Close()" />
