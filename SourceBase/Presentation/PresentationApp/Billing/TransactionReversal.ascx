                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Panel ID="pnlPopupReversalNotes" runat="server" Style="display: none; background-color: #FFFFFF;
                                                                        ...
                                                                        <div style="background-color: #479ADA; height: 30px; color: White; line-height: 30px;
                                                                            text-align: center; font-weight: bold;">Reversal Reason
                                                                            <br />
                                                                        </div>
                                                                        <div style="min-height: 50px; line-height: 30px; text-align: left; font-weight: bold; padding:5px;">
                                                                ...
                                                                <ItemTemplate>
                                                                    <div style="text-align: center; padding: 10px; white-space: nowrap; display: <%# ShowApproval(Eval("ApprovalStatus")) %>">
                                                                        <asp:Button ID="btnApprove" runat="server" Text="Approve" Height="21px" Style="margin-right: 10px"
                                                                             ForeColor="Black" CommandName="Approve" CommandArgument="<%# Container.DataItemIndex %>" />
                                                                        <asp:Button ID="btnReject" runat="server" Text="Reject" Height="21px" 
                                                                            ForeColor="Black" CommandName="Reject" CommandArgument="<%# Container.DataItemIndex %>" />
                                                                    </div>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField InsertVisible="False" ShowHeader="False">
                                                                    ...
                                                                    <div style="white-space: nowrap">
                                                                        ...
                                                                        <asp:Panel ID="pnlRefundPopup" runat="server" Style="display: none; background-color: #FFFFFF;
                                                                            ...
                                                                            <div style="padding: 3px;" align="center">
                                                                                <asp:Button ID="btnRefundYes" runat="server" Text="Refund"  />
                                                                                <asp:Button ID="btnRefundNo" runat="server" Text="Cancel" Style="margin-left: 10px" /></div>
                                                                        </asp:Panel>
                                                                        <span style='display: <%# ShowPrintRefund(Eval("Refunded")) %>; white-space: nowrap'>
                                                                            <asp:Button ID="refundPrint" runat="server" CausesValidation="false" CommandName="PrintRefund"
                                                                                Text="Print Refund" CommandArgument="<%# Container.DataItemIndex %>" />
                                                                        </span>
                                                                    </div>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
    ...
    <asp:UpdatePanel ID="billItemPanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="divBillItems" runat="server" Style="display: none; width: 680px; border: solid 1px #808080;
                ...
                <asp:Panel ID="divItemTitle" runat="server" Style="border: solid 1px #479ADA; margin: 0px 0px 0px 0px; background-color:#479ADA;
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="divParameters" runat="server" Style="display: none; width: 380px;
                ...
                <asp:Panel ID="divTitle" runat="server" Style="border: solid 1px #479ADA; margin: 0px 0px 0px 0px;
                    cursor: move; height: 18px; background-color:#479ADA">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 18px">
                        <tr>
                            <td style="width: 5px; height: 19px;">
                            </td>
