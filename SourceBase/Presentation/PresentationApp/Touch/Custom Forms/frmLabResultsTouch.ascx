<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="frmLabResultsTouch.ascx.cs"
    Inherits="Touch.Custom_Forms.frmLabResultsTouch" %>
<div style="visibility: collapse">
    <telerik:radbutton id="btnSave" runat="server" text="Save" onclientclicking="LoadingPanel"
        skin="MetroTouch" onclick="BtnSaveClick">
    </telerik:radbutton>
</div>
<div id="FormContent">
                            ...
                            <td colspan="4">
                             <a id="sGrid" href="#sGrid"></a>
                                <telerik:RadGrid AutoGenerateColumns="false" ID="RadGridLabTest" runat="server" Width="100%"
                                    ...
                                    onitemdatabound="RadGridLabTest_ItemDataBound" onPreRender="RadGridLabTest_PreRender">
                        ...
                        <tr>
                         <td colspan="4">
                          ...
                          <tr>
                           ...
                           <td>
<%--                           <telerik:RadButton ID="btnPrint" runat="server" Text="Print" Skin="MetroTouch" OnClientClicked="parent.ShowLoading" Visible="true"></telerik:RadButton>--%>
                           <telerik:RadButton ID="btnPrint" runat="server" Text="Print" Skin="MetroTouch" OnClick="btnPrint_OnClick" Visible="true"></telerik:RadButton>
                           </td>
                          </tr>
                          </table>
                         </td>
