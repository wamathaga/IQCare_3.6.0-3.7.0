...
<xs:schema id=""ItemMasterData"" xmlns="""" xmlns:xs=""http://www.w3.org/2001/XMLSchema"" xmlns:msdata=""urn:schemas-microsoft-com:xml-msdata""> 	
	<xs:element name=""ItemMaster"" msdata:IsDataSet=""true"" msdata:UseCurrentLocale=""true"">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (Authentication.HasFunctionRight(Convert.ToString(ViewState["ListName"]), FunctionAccess.Update, (DataTable)Session["UserRight"]) == false)
            {
                if (buttonAddItem.Enabled == true){buttonSubmitItem.Enabled = true;}
                if (buttonAddSubType.Enabled == true)
                {
                    buttonSubmitST.Enabled = true;
                }
            } 
        ...
        void gridItemList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "RowClick")
                {
                    ...
                    {
                        buttonSubmitItem.Enabled = false;
                    } 
        ...
        protected void SaveItem(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.NotifyAction(
                string.Format("{0} {1} ", "", ((actionType == "NEW") ? "Item Added Successfully." : "Item Updated Successfully.")), ((actionType == "NEW") ? "Add" : "Edit"), false);
                //parameterPopup.Hide();
                this.ActionType = "VIEW";
            }
            catch (Exception wz)
        ...
        private void NotifyAction(string strMessage, string strTitle, bool errorFlag)
        {
            ...
            strMessage = textInfo.ToTitleCase(strMessage);
            // End Bug ID 138
        ...
        protected void buttonSubmitST_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (actionType == "NEW_ST")
                {
                    ...
                    this.NotifyAction("Sub Type Item Added Successfully.", string.Format("{0} {1} ", "", "Add"), false);
                }
                else if (actionType == "EDIT_ST")
                {
                    ...
                    this.NotifyAction("Sub Type Item Updated Successfully.", string.Format("{0} {1} ", "", "Edit"), false);
 
                }
                PopulateItemSubTypes(true);
        ...
        protected void gridSubTypes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "RowClick")
                {
                    ...
                    this.ActionType = "EDIT_ST";
                    buttonSubmitST.Enabled = Authentication.HasFunctionRight(Convert.ToString(ViewState["ListName"]), FunctionAccess.Update, (DataTable)Session["UserRight"]); 
                    mpeSubTypePopup.Show();
                }
