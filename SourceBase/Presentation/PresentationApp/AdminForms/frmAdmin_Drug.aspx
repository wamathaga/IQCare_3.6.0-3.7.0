            ...
            <div class="border center formbg">
                <table cellspacing="6" cellpadding="0" width="100%" border="0">
                    <tbody>
                        <tr>
                            <td class="form" style="width: 50%; height: 141px" align="left">
                                <table width="100%" cellpadding="5px" cellspacing="5px">
                                    <tr>
                                        <td style="width: 35%;" align="right"><label class="right30">Drug type :</label></td>
                                        <td><asp:DropDownList ID="ddDrugTypeID" runat="server" OnSelectedIndexChanged="ddDrugType_SelectedIndexChanged" AutoPostBack="True">
                                        </asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label class="right30">Trade name :</label></td>
                                        <td><asp:TextBox ID="txtDrugName" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label class="right30">Drug abbreviation :</label></td>
                                        <td><asp:TextBox ID="txtDrugAbbre" ReadOnly="true" runat="server"></asp:TextBox></td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td class="border center pad5 whitebg" style="width: 50%" align="left">
                                <div id="vaccshow" runat="server" style="display:none">
                                    <label class="Center">
