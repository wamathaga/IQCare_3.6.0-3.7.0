...
function w_displayCal()
{
	...
	{
		weeklyCalendar.style.left=window.event.x+document.body.scrollLeft+5;
    ...
    weeklyCalendar.style.top=window.event.y+document.body.scrollTop+65;
    }
...
function buildWeeklyCalendar(WeekStart,Position)
{
    ...
    document.write('</td>');
    //Jayant 04-03-2008-Begin
    if (WeekStart==0 && Position==0){document.write('<td align="center" onClick="w_hiddenCalendar()"><img src="../images/close.gif" title="' + close_title + '" border="0"></td>');}
    else {document.write('<td align="center" onClick="w_hiddenCalendar()"><img src="./images/close.gif" title="' + close_title + '" border="0"></td>');}
    //End
