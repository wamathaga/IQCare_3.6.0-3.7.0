$(function() {
    ...
    //notifications.createNotification({ message: 'This is a notification', type: 'none', category: 'allergies' });
    //here
    ...
    $('#notification-form').submit(function() {
        ...
        if ($.inArray(type, ['success', 'error', 'warning', 'notice']) == -1){

            var options = {
                autoHide:$form.find('#auto-hide').is(':checked') ? true : false,
                autoHideDelay:$form.find('#auto-hide-delay').val(),
                type:type,
            ...
            notifications[type](($form.find('#message') != '') ? $form.find('#message').val() : 'Sample Notification');
        }
