<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="True" Inherits="CustomFields_frmConfig_Customfields"
...
<link type="text/css" href="../Style/_assets/css/round.css" rel="stylesheet" />--%>
    <div>
        ...
        <%-- <form id="formconfigcustomfield" method="post" runat="server" name="form1">--%>
                                ...
                                <tr>
                                    <td class="border pad5 whitebg" valign="top" width="50%">
                                        <label class="margin20" style="vertical-align: top;">
                                            Field Label:</label><asp:TextBox ID="txtflabel" CssClass="pad5"  runat="server" Width="300px" MaxLength="90"></asp:TextBox><br />
                                        <br />
                                        <label class="margin20" style="vertical-align: top;">
                                            ...
                                            <div class="mid-inner">
                                                <div class="mid" style="cursor: pointer; height: 280px; overflow: auto;">
                                                    <div id="div-gridview" class="gridview whitebg">
                                                        <asp:GridView ID="grdCustomfields" runat="server" AllowSorting="true" 
                                                            OnRowDataBound="grdCustomfields_RowDataBound" DataKeyNames="CustomFieldID" AutoGenerateColumns="False"
                                                            Width="884" CssClass="datatable" CellPadding="0" CellSpacing="0" BorderWidth="0"
                                                            ...
                                                            EnableViewState="False" PageSize="1">
