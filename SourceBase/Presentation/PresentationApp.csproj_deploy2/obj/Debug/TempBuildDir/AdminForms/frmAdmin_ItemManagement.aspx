                ...
                <act:TabPanel ID="TabPanel3" runat="server" Font-Size="Large" HeaderText="Item Configuration">
                    <ContentTemplate>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 80%; height: 40px" align="center" class="pad5">
                                        ...
                                        <act:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" CompletionInterval="30"
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight" CompletionListItemCssClass="AutoExtenderList" OnClientShown="resetPosition"
                                            ...
                                            <table width="100%">
                                                <tr align="right">
                                                    <td align="right" colspan="2" width="2%">
                                                        <asp:LinkButton ID="btnbatchsummary" Visible="False" Text="Batch Summary" 
                                                            runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                        ...
                        <act:ModalPopupExtender ID="mp1" runat="server" PopupControlID="Panl1" TargetControlID="dummyButton"
                            CancelControlID="btnPendingOrdersClose" BackgroundCssClass="Background" 
                            BehaviorID="_content_mp1" DynamicServicePath="" >
                        </act:ModalPopupExtender>
                        <act:ModalPopupExtender ID="ModalPopupExtender1" runat="server" PopupControlID="pnlbatchsummary"
                            TargetControlID="btnbatchsummary" CancelControlID="imgbatchclose" 
                            BackgroundCssClass="Background" BehaviorID="_content_ModalPopupExtender1" 
                            DynamicServicePath="">
                        </act:ModalPopupExtender>
                        <asp:Table ID="Panl1" runat="server" Width="550px" Height="300px" BackColor="White">
                            <asp:TableRow runat="server">
                                <asp:TableCell Height="20px" CssClass="formbg" runat="server"><asp:Table ID="Table11" runat="server" Width="100%"><asp:TableRow 
                                        runat="server"><asp:TableCell HorizontalAlign="Left" VerticalAlign="Middle" 
                                        ForeColor="Navy" Font-Bold="True" runat="server"><asp:Label ID="lblGenStrPopup" class="forms" runat="server"></asp:Label>
</asp:TableCell>
<asp:TableCell HorizontalAlign="Right" VerticalAlign="Middle" runat="server"><asp:ImageButton ID="btnPendingOrdersClose" runat="server" ImageUrl="~/Images/closeButton1.png"
                                                    Height="20px" />
</asp:TableCell>
</asp:TableRow>
</asp:Table>
                        ...
                        <asp:Table ID="pnlbatchsummary" runat="server" Width="700px" Height="200px" BackColor="White" style="display:none">
                            <asp:TableRow runat="server">
                                <asp:TableCell Height="20px" CssClass="formbg" runat="server"><asp:Table ID="pnltable" runat="server" Width="100%"><asp:TableRow 
                                        runat="server"><asp:TableCell HorizontalAlign="Left" VerticalAlign="Middle" 
                                        ForeColor="Navy" Font-Bold="True" runat="server"><asp:Label ID="lblbatchs" class="forms" runat="server" Text="Batch Summary"></asp:Label>
</asp:TableCell>
<asp:TableCell HorizontalAlign="Right" VerticalAlign="Middle" runat="server"><asp:ImageButton ID="imgbatchclose" runat="server" ImageUrl="~/Images/closeButton1.png"
                                                    Height="20px" />
</asp:TableCell>
</asp:TableRow>
</asp:Table>
