<%@ Page AutoEventWireup="true" MasterPageFile="~/MasterPage/IQCare.master"
    Inherits="frmReport_PatientARVPickup" Language="C#" Codebehind="frmReport_PatientARVPickup.aspx.cs" %>
                ...
                <tr>
                    <td class="border center whitebg" style="padding-bottom:1%;">
                        ...
                        <img src="../Images/cal_icon.gif" height="22" alt="Date Helper" hspace="3" border="0"
                            onclick="w_displayDatePicker('<%= txtStartDate.ClientID%>');" style="vertical-align:bottom; margin-bottom:2px;" />
                        <span class="smallerlabel">(DD-MMM-YYYY)</span>
                        <label style="margin-left:5%;">
                            To</label>
                        <asp:TextBox ID="txtEndDate" MaxLength="11" Width="75px" runat="server"></asp:TextBox>
                        <img src="../Images/cal_icon.gif" height="22" alt="Date Helper" hspace="3" border="0"
                            onclick="w_displayDatePicker('<%= txtEndDate.ClientID%>');" style="vertical-align:bottom; margin-bottom:2px;" />
                        <span class="smallerlabel">(DD-MMM-YYYY)</span>
                    </td>
                </tr>
                <tr>
