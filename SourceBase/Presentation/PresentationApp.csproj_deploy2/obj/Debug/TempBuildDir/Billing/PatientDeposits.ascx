...
<asp:UpdatePanel ID="notificationPanel" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Button ID="btnRaisePopup" runat="server" Text="New Deposit" Width="92px" Style="display: block;margin-bottom:5px"
            class="greenbutton" />
                            ...
                            <tr>
                                ...
                                <td rowspan="4" align="center" width="25%">
                                    <asp:Button ID="buttonViewTransactions" runat="server" Text="View Transactions" Height="30px"
                                        Font-Bold="True" ForeColor="InfoText" Width="57%" Enabled="True" OnClick="buttonViewTransactions_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold; height: 30px;">
                                    ...
                                    <div style="white-space: nowrap;vertical-align:middle; text-align:left">
                                        ...
                                        <asp:Panel ID="pnlRefundPopup" runat="server" Style="display: none; background-color: #FFFFFF;
                                            ...
                                            <div style="padding: 3px;" align="center">
                                                <asp:Button ID="btnRefundYes" runat="server" Text="Return" ForeColor="Black" />
                                                <asp:Button ID="btnRefundNo" runat="server" Text="Cancel" ForeColor="Black" Style="margin-left: 10px" /></div>
                                        </asp:Panel>
                                    </div>
                                </td>
                            </tr>
                                            ...
                                            <div class="mid" style="height: 280px; overflow: auto">
                                                <div id="div-depositGridview" class="GridView whitebg">
                                                    <asp:GridView ID="gridTransaction" runat="server" AllowSorting="False" AutoGenerateColumns="False"
                                                        BorderColor="White" BorderWidth="1px" CellPadding="0" CssClass="datatable" DataKeyNames="transactionid"
