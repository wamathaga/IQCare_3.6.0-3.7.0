<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" EnableEventValidation="False"
    AutoEventWireup="true" Inherits="ClinicalForms_frmClinical_Enrolment" Title="Untitled Page"
                            ...
                            <tbody>
                                <tr>
                                    <td class="border pad5 whitebg" align="center" colspan="2" style="height: 58px">
                                        ...
                                        <input id="rbtnknownHIVStatusYes" runat="server" onmouseup="up(this);" onfocus="up(this);"
                                            onclick="down(this); hide('discuss');" type="radio" value="Y" name="knownHIVStatus" />
                                        <label for="y">
                                            Yes</label>
                                        <input id="rbtnknownHIVStatusNo" runat="server" onmouseup="up(this);" onfocus="up(this);"
                                            onclick="down(this); show('discuss');" type="radio" value="N" name="knownHIVStatus" />
                                        <label for="n">
                                            No</label>
                                        ...
                                        <div class="margin80" id="discuss" style="display: none">
                                            ...
                                            <input id="rbtnHIVdiscussStatusYes" runat="server" onmouseup="up(this);" onfocus="up(this);"
                                                onclick="down(this);" type="radio" value="Y" name="discussStatus" />
                                            <label for="y">
                                                Yes</label>
                                            <input id="rbtnHIVdiscussStatusNo" runat="server" onmouseup="up(this);" onfocus="up(this);"
                                                onclick="down(this);" type="radio" value="N" name="discussStatus" />
                                            <label for="n">
                                                No</label>
                                        </div>
                                    </td>
                                            ...
                                            <tr>
                                                <td nowrap="nowrap" colspan="2">
                                                    <div class="pad5" id="medRecordsdiv" style="display: none">
                                                        ...
                                                        <input id="rbtnmedRecordsYes" onmouseup="up(this);" onfocus="up(this);" onclick="down(this);"
                                                            type="radio" value="0" name="medRecords" runat="server" />
                                                        <label for="y">
                                                            Yes</label>
                                                        <input id="rbtnmedRecordsNo" onmouseup="up(this);" onfocus="up(this);" onclick="down(this);"
                                                            type="radio" value="1" name="medRecords" runat="server" />
                                                        <label for="n">
                                                            No</label></div>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="border pad5 whitebg" valign="top" align="left">
                                        ...
                                        <input id="rbtnsupportGroupYes" type="radio" value="1" name="supportGroup" runat="server"
                                            onmouseup="up(this);" onfocus="up(this);" onclick="down(this); show('supportName');" />
                                        <label for="Y">
                                            Yes</label>
                                        <input id="rbtnsupportGroupNo" type="radio" value="0" name="supportGroup" runat="server"
                                            onmouseup="up(this);" onfocus="up(this);" onclick="down(this); hide('supportName');" />
                                        <label for="N">
                                            No</label>
