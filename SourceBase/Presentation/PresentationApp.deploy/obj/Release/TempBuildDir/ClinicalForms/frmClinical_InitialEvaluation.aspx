<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="true" Inherits="frmClinical_InitialEvaluation"
                ...
                <tbody>
                    <tr>
                        <td class="form center" colspan="2" valign="middle">
                            ...
                            <label  id="TempVal">
                                Temp:</label>
                            <input id="txtphysTemp" maxlength="4" size="4" name="physTemp" runat="server" />
                            <span class="smallerlabel">C</span>
                            <label class="margin5">
                                RR:</label><input id="txtphysRR" maxlength="4" size="4" name="physRR" runat="server" />
