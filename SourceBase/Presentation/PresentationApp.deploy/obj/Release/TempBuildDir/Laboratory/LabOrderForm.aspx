<%@ Page Language="C#" AutoEventWireup="true" Inherits="Laboratory_LabOrderForm" Codebehind="LabOrderForm.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function removelink(pnlparentid, pnlchdid, labid, rowid) {
            ...
            if (confirm('Are you sure you want to Remove this Test?')) {
                ...
                var result = Laboratory_LabOrderForm.UpdateTable(labid).value;
        ...
        function fnSave() {
            ...
            if (document.getElementById("txtlaborderedbydate").value == "") {
                alert("Order by date can not be blank");
                return false;
            }
            ...
            var result = Laboratory_LabOrderForm.Save(labtobedone, strlaborder, orderbydate, appcurrentdate).value;
            if (result != "false") {
