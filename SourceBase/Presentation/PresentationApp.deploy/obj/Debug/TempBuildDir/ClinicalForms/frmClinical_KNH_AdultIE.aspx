                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td width="18%" align="right">
                                                                <label class="required">
                                                                <asp:Label ID="lblPatRef" runat="server" CssClass="required" Font-Bold="True" 
                                                                                        Text="*Patient referred from:"></asp:Label>
                                                                    </label>
                                                            </td>
                                            ...
                                            <td colspan="2" align="left">
                                                <asp:Panel ID="pnlPE" CssClass="border center formbg" runat="server" Style="padding: 6px">
                                                    <h2 class="forms" align="left">
                                                        ...
                                                        <asp:Label ID="lblPhysicalExamination" runat="server" Text="Physical Examination"></asp:Label></h2></h2>
                                                </asp:Panel>
                                            </td>
                                        </tr>
                                    </table>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="left">
                                                                <label>
                                                                    Work up plan:</label>
                                                                <asp:TextBox ID="txtWorkUpPlan" runat="server" Skin="MetroTouch" Columns="20" Rows="2" Width="100%"
                                                                                            TextMode="MultiLine">
                                                                </asp:TextBox>
                                                            </td>
                                                        </tr>
