                ...
                <tbody>
                    <tr>
                        <td class="pad5 whitebg border" style="width: 50%" colspan="2">
                            ...
                            <asp:DropDownList ID="ddAuditTrail" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td>
                        </td>
                                                    ...
                                                    <div class="mid-inner">
                                                        <div class="mid" style="cursor: pointer; height: 280px; overflow:auto; border: 1px solid #666699;">
                                                            <div id="div-gridview" class="whitebg" >
                                                                <asp:GridView ID="GrdAuditTrail" runat="server" Width="884"
                                                                    PageSize="1" CssClass="datatable" AutoGenerateColumns="True" CellPadding="0"
