                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 50%" align="left">
                                                                    <input id="txtdtLMP" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                        ...
                                                                        size="11" type="text" />&nbsp;</input></input> </input></input>&nbsp; &nbsp; <img id="Img1"
                                                                ...
                                                                <table width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            &nbsp;</td>
                                                                            <td style="width: 60%" align="left">
                                                                                <asp:DropDownList ID="ddloccupational" onchange="dropdownchangetext('ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_ddloccupational','divotheroccupational','Other Specify','ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_txtotherPEP');"
                                                                                    runat="server">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <table width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            &nbsp;</td>
                                                                            <td style="width: 60%" align="left">
                                                                                <asp:DropDownList runat="server" ID="ddlbodyfluid" onchange="dropdownchangetext('ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_ddlbodyfluid','divbodyfluid','Other Specify','ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_txtfluidother');">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                ...
                                                                <table width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            &nbsp;</td>
                                                                            <td style="width: 60%" align="left">
                                                                                <asp:DropDownList runat="server" ID="ddlnonoccupational" onchange="dropdownchangetext('ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_ddlnonoccupational','divnonoccupational','Other Specify','ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_txtnonoccupationalother');">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                ...
                                                                <table width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            &nbsp;</td>
                                                                            <td style="width: 60%" align="left">
                                                                                <asp:DropDownList runat="server" ID="ddlsexualassault" onchange="dropdownchangetext('ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_ddlsexualassault','divsexualassault','Other (specify)','ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_txtothersexual');">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                ...
                                                                <table width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:DropDownList runat="server" ID="ddlpepregimen" onchange="dropdownchangetext('ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_ddlpepregimen','divotherpep','Other','ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_txtotherpepregimen');">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <input id="datecurrentpepregimen" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                    onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                    size="11" type="text" />
                                                                                &nbsp;</input>&nbsp; <img id="Img2" alt="Date Helper" border="0" height="22 " hspace="5" name="appDateimg"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <input id="txtPEPRegimenEndDate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                    onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                    size="11" type="text" />
                                                                                &nbsp;</input>&nbsp; <img id="Img4" alt="Date Helper" border="0" height="22 " hspace="5" name="appDateimg"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 40%" align="left">
                                                                    <input id="rdohbvvaccinationyes" runat="server" name="hbv" onclick="down(this);"
                                                                        onfocus="up(this);" onmouseup="up(this);" type="radio" />
                                                                    <label>
                                                                    Yes</label><input ID="rdohbvvaccinationno" runat="server" name="hbv" 
                                                                        onclick="down(this);" onfocus="up(this);" onmouseup="up(this);" type="radio"></input></input></input></input></input></input></input></input></input><label>No</label>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 40%" align="left">
                                                                    <input id="rdodiscusseddisclosureyes" runat="server" name="disclosureplan" onclick="down(this);"
                                                                        onfocus="up(this);" onmouseup="up(this);" type="radio" />
                                                                    <label>
                                                                    Yes</label><input ID="rdodiscusseddisclosureno" runat="server" 
                                                                        name="disclosureplan" onclick="down(this);" onfocus="up(this);" 
                                                                        onmouseup="up(this);" type="radio"></input></input></input></input></input></input></input></input></input><label>No</label>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="width: 40%" align="left">
                                                                    ...
                                                                    <label>
                                                                    Yes</label><input ID="rdosafesexno" runat="server" name="safesex" 
                                                                        onclick="down(this);" onfocus="up(this);" onmouseup="up(this);" type="radio"></input></input></input></input></input></input></input></input></input><label>No</label>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 40%" align="left">
                                                                    <input id="rdoadherencecounsellingyes" runat="server" name="adherence" onclick="down(this);"
                                                                        onfocus="up(this);" onmouseup="up(this);" type="radio"></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input><label>Yes</label><input id="rdoadherencecounsellingno" runat="server" name="adherence"
                                                                            onclick="down(this);" onfocus="up(this);" onmouseup="up(this);" type="radio"></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input><label>No</label>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 40%" align="left">
                                                                                <input id="rdocondomsdispensedyes" runat="server" name="condoms" onclick="down(this);rblSelectedValue(0,'divreasonfornotissue');fnReset('ctl00_IQCareContentPlaceHolder_tabControlKNHPEP_tbpnlClinicalAssessment_txtreasonfornotissuecondoms','txt');"
                                                                                    onfocus="up(this);" onmouseup="up(this);" type="radio"></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input><label>Yes</label><input id="rdocondomsdispensedno" runat="server" name="condoms" onclick="down(this);rblSelectedValue(1,'divreasonfornotissue');"
                                                                                        onfocus="up(this);" onmouseup="up(this);" type="radio"></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input></input><label>No</label>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
