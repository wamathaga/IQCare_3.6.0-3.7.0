                                                    ...
                                                    <div class="ShowProtectedSexYN" style="display: none">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td style="width: 20%;">
                                                                    <telerik:RadComboBox ID="cbOtherFamilyPlanning" CheckBoxes="true" CheckedItemsTexts="FitInInput"
                                                                        runat="server" Skin="MetroTouch" OnClientItemChecked="ShowOtherFPlanning">
                                                                    </telerik:RadComboBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <telerik:RadGrid ID="rgAE" runat="server" AutoGenerateColumns="False" CellSpacing="0"
                                                            ...
                                                            <MasterTableView DataKeyNames="EventCatID">
                                                                <Columns>
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Severity" UniqueName="Severity">
                                                                        <ItemTemplate>
                                                                            <telerik:RadComboBox ID="rcbAESeverity" runat="server">
                                                                            </telerik:RadComboBox>
                                                                        </ItemTemplate>
                        ...
                        <MasterTableView>
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn DataField="Type" ReadOnly="false" FilterControlAltText="Filter Type column"
                                    HeaderText="Type" UniqueName="Type" DataType="System.Boolean">
                                    <ItemTemplate>
                                        <telerik:RadButton ID="btnResSens" runat="server" AutoPostBack="false" ToggleType="CustomToggle"
                                            ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Unknown" />
                                                <telerik:RadButtonToggleState Text="Sensitive" CssClass="BlueBG" />
                                                <telerik:RadButtonToggleState Text="Resistant" CssClass="BlueBG" />
                                            </ToggleStates>
                                        </telerik:RadButton>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
...
<div style="visibility: collapse">
    <telerik:RadButton ID="btnSave" runat='server' Text="Test" CausesValidation="true" OnClientClicking="CheckVals"
...
<div id="frmVisit_ScriptBlock" runat="server" style="display: none;">
    <script type="text/javascript">
        ...
        function SetDate(sender, args) {
            ...
            dateVar.AddDays(parseInt(weekS) * 7);
    ...
    <script type="text/javascript" src="Scripts/keyb/jquery.keyboard.js"></script>
    <script type="text/javascript" src="Scripts/keyb/jquery.keyboard.extension-typing.js"></script>
    <script type="text/javascript" src="Scripts/keyb/demo/demo.js?reload"></script>
</div>
