...
<body style="background-color: White">
    ...
    <div id="theWrapper" style="position: absolute; top: 0; bottom: 0; left: 0; right: 0;">
        ...
        <div id="loginDiv" class="target">
            <div id="toggle">
                ...
                <br />
                <br />
                <div style="display: none;" runat="server" id="contPtrnLock">
                    <div style="text-align: center;">
                        Locked for :&nbsp;<label runat="server" id="lblCurUser"></label>&nbsp; [<asp:LinkButton
                            runat="server" ID="btnNotMe" OnClick="btnNotMe_Click">Not Me</asp:LinkButton>]</div>
    ...
    <telerik:RadButton ID="btnSetPattern" runat="server" Style="display: none;">
    </telerik:RadButton>
