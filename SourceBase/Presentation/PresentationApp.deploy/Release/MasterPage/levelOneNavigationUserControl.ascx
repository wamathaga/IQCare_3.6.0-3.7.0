...
<script type="text/javascript">
    ...
    function openWin() {
        window.open('../frmDBBackupSetup.aspx','','ToolBar=no,Location=no,status=yes,scrollbars=no,top=200,left=300,resizable=no,width=450,height=500');
    }
                    ...
                    <tr>
                        <td valign="bottom">
                            <asp:Menu ID="mainMenu" runat="server" Orientation="Horizontal" CssClass="levelOneMenu"
                                Width="570px" RenderingMode="Table" StaticEnableDefaultPopOutImage="False"
                                StaticSubMenuIndent="" StaticSelectedStyle-ItemSpacing="0px" StaticMenuItemStyle-ItemSpacing="0px">
                                ...
                                <Items>
                                    <asp:MenuItem Text="Find/Add Patient" Value="Find/Add Patient" NavigateUrl="~/frmFindAddPatient.aspx">
                                    </asp:MenuItem>
                                    ...
                                    <asp:MenuItem Text="Administration" Value="Administration" Selectable="False" NavigateUrl="~/frmFacilityHome.aspx">
                                        ...
                                        <asp:MenuItem Text="Delete Patient" Value="Delete Patient" 
                                            NavigateUrl="~/frmFindAddPatient.aspx?mnuClicked=DeletePatient"></asp:MenuItem>
                                    ...
                                    <asp:MenuItem Text="Back Up" Value="Back Up" Selectable="False" NavigateUrl="~/frmDBBackup.aspx">
                                        ...
                                        <asp:MenuItem Text="Backup/Restore setup" Value="Backup/Restore setup" NavigateUrl="javascript:openWin();" Target="_self">
                                        </asp:MenuItem>
                                    </asp:MenuItem>
                                    <asp:MenuItem Text="Facility Home" Value="Facility Home" NavigateUrl="~/frmFacilityHome.aspx">
                                    </asp:MenuItem>
                                </Items>
                            </asp:Menu>
                        </td>
