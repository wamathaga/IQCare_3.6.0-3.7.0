<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/IQCare.master" Inherits="Laboratory_LabOrder" Title="Untitled Page"
    MaintainScrollPositionOnPostback="true" EnableViewState="true" Codebehind="frmLabOrder.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    ...
    <div class="center" style="padding: 8px;">
        ...
        <span style="margin-left: 835px">
            <asp:LinkButton ID="lnkLabTest" runat="server" Text="Edit Lab Order" OnClick="lnkLabTest_Click" Visible="false"></asp:LinkButton></span>
                        ...
                        <tr>
                            <div id="div9" runat="server">
                                <td class="form" align="left" width="50%" rowspan="2">
                                    <span id="sp53" disabled="disabled">
                                        <label id="lblsero">
                                            HIV Rapid Test:</label>
                                    ...
                                    </span><span id="sp101" value="101" disabled="disabled">
                                        <div id="div7" runat="server" align="right">
                                            <asp:CheckBox ID="HIVSerologyConfirm" Value="1" Enabled="false" runat="server" />
                                            <label>
                                                Confirmatory</label>
                                        </div>
                                    </span><span id="sp110" value="110" disabled="disabled">
                                        <label id="lblPCR">
                                            PCR:</label>
                            ...
                            <td class="form" align="center" id="td1" disabled="true">
                                ...
                                <asp:Label ID="lblCD4" runat="Server" CssClass="smalllabel"></asp:Label>
                        ...
                        <tr>
                            <td class="form" align="center" width="50%" valign="top">
                                ...
                                &nbsp;&nbsp; <span id="sp2AFB" disabled="disabled">
                                    ...
                                    <input type="radio" id="sputumafb22" name="sputumafb21" value="2" class="margin20left"
                                        onfocus="up(this)" onclick="down(this)" runat="server" disabled="disabled" /><label>Neg</label></span><br />
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp;<span id="sp3AFB" disabled="disabled"><label id="lblSpAFB3">
                                    #3:
                                </label>
                            ...
                            <td class="form" align="center" width="50%" valign="top" id="tdGStain" disabled="disabled">
                                <label id="lblGstain">
                                    Gram Stain:</label>
                                <div class="center">
                                    <textarea name="gramStain" id="txtgramStain" rows="4" cols="70" disabled="disabled" runat="server"></textarea></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                        ...
                        <tr>
                            ...
                            <td class="form" valign="top" style="width: 49%" align="left">
                                ...
                                <div id="divstool" disabled="disabled">
                                    <input type="radio" runat="server" id="rdoStoolList" disabled="disabled" name="StoolList" value="1" onfocus="up(this)"
                                        onclick="down(this);ClearStoolDesc();" /><label>Pos</label>
                                    <input type="radio" runat="server" disabled="disabled" id="rdoStoolList2" name="StoolList" value="2"
                                        class="margin20left" onfocus="up(this)" onclick="down(this);ClearStoolDesc();" /><label>Neg<br />
                                        </label>
                                </div>
                        ...
                        <tr>
                            <td class="form" align="left">
                                ...
                                <div id="divX-Ray" disabled="disabled">
                                    <input type="radio" runat="server" id="rdochestxray1" disabled="disabled" name="listchestxray" value="1"
                                        onfocus="up(this)" onclick="down(this)" /><label>Normal</label>
                                    <input type="radio" runat="server" id="rdochestxray2" disabled="disabled" name="listchestxray" value="2"
                                        class="margin20left" onfocus="up(this)" onclick="down(this)" /><label>Abnormal</label></div>
