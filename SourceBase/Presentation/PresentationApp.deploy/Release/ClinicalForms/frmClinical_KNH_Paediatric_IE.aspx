                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 32%" align="left">
                                                                                <asp:RadioButtonList ID="rbListFatherAlive" runat="server" RepeatDirection="Horizontal"
                                                                                    OnClick="rblSelectedValue1(this,'divdatefatherdeath','ctl00_IQCareContentPlaceHolder_tabControl_TabTriage_txtdateoffatherdeath')">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 36%" align="left">
                                                                                <asp:RadioButtonList ID="rbListMotherAlive" runat="server" RepeatDirection="Horizontal"
                                                                                    OnClick="rblSelectedValue1(this,'divdateofmotherdeath','ctl00_IQCareContentPlaceHolder_tabControl_TabTriage_txtdateofmotherdeath')">
                                                                                    <asp:ListItem Text="Yes" Value="0" ></asp:ListItem>
                                                                                    <asp:ListItem Text="No" Value="1"></asp:ListItem>
                                                                                </asp:RadioButtonList>
                                                                            </td>
                                                                ...
                                                                <table width="100%" border="0">
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 25%;" align="left">
                                                                            <asp:RadioButtonList ID="rbListMilestone" onclick="rblSelectedValue1(this,'divmilestoneshowhide','ctl00_IQCareContentPlaceHolder_tabControl_TabExamination_txtspecifywhyinappropriate');"
                                                                                    runat="server" RepeatDirection="Horizontal">
                                                                                    <asp:ListItem Text="Yes" Value="0" ></asp:ListItem>
                                                                                    <asp:ListItem Text="No" Value="1"></asp:ListItem>
                                                                            </asp:RadioButtonList>
