                    ...
                    <tr>
                        <td class="form" width="50%" align="center" style="height: 38px">
                            ...
                            <img onclick="w_displayDatePicker('<%= txtvisitDate.ClientID%>');SendCD4();" height="22"
                                ...
                                id="IMG1" style="vertical-align: bottom; margin-bottom: 2px;" /><span class="smallerlabel">(DD-MMM-YYYY)</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="form" valign="top" width="50%" align="left">
                            ...
                            <input id="rdoartAssessmentID" type="radio" value="" name="artAssessmentID" runat="server"
                                onmouseup="up(this);" onfocus="up(this);" onclick="down(this);" /><span class="smalllabel">Re-evaluate</span>
                            <input id="rdoartAssessmentID2" type="radio" value="" name="artAssessmentID" runat="server"
                                onmouseup="up(this);" onfocus="up(this);" onclick="down(this);" /><span class="smalllabel">Prepare
                                    for ART</span>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img onclick="w_displayDatePicker('<% =txtpharmReportedbyDate.ClientID %>');" height="22"
                                            alt="Date Helper" hspace="5" src="../images/cal_icon.gif" width="22" border="0"
                                            name="appDateimg" style="vertical-align: bottom; margin-bottom: 2px;" /><span class="smallerlabel">(DD-MMM-YYYY)</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
