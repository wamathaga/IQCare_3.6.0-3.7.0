                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="form pad5 center">
                                            <br />
                                            <asp:Button ID="btn_saveBill" runat="server" OnClick="btn_saveBill_Click" Text="Save" /><asp:Button
                                                ID="buttonGenerateBill" runat="server" Text="Generate Bill" OnClick="GenerateBill_Click"
                                                OnPreRender="buttonGenerateBill_PreRender" /><asp:Button ID="btn_print1" runat="server"
                                                    OnClick="btn_print_Click" OnClientClick="PrintGrid('div-gridview')" Text="Print" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
