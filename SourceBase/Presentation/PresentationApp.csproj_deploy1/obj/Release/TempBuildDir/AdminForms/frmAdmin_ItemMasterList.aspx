                    ...
                    <td align="left" style="padding-left: 10px; padding-right: 15px">
                        ...
                        <asp:UpdatePanel runat="server" ID="updatePanelMasterItem" UpdateMode="Always">
                            <ContentTemplate>
                                ...
                                <table border="0" cellpadding="6" cellspacing="0" class="mid" style="cursor: pointer;
                                    display: block; height: 40px; overflow: auto; border: 1px solid #666699;">
                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="pad5 formbg border">
                                                                    ...
                                                                    <div class="mid-inner">
                                                                        <div class="mid" style="cursor: pointer; height: 280px; max-height: 480px; overflow: auto;
                                                                            ...
                                                                            <div id="div-gridview" class="whitebg">
                                                                                <asp:GridView ID="gridItemList" CssClass="datatable" CellPadding="0" runat="server"
                                                            ...
                                                            <asp:Panel ID="divData" runat="server" Style="display: none; width: 680px; border: solid 1px #808080;
                                                                background-color: #479ADA; z-index: 15000; overflow: auto;">
                                    ...
                                    <asp:UpdatePanel ID="divDetailsCompnent" UpdateMode="Conditional" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:Panel ID="panelDetails" runat="server" Style="display: block; width: 680px;
                                                border: solid 1px #808080; background-color: #6699FF; z-index: 15000; overflow: auto;
                                                max-height: 480; min-height: 240">
                                                <asp:Panel ID="panelTitle" runat="server" Style="border: solid 1px #808080; margin: 0px 0px 0px 0px;
                                                    cursor: move; height: 18px">
                                                                    ...
                                                                    <div class="mid-inner">
                                                                        <div class="mid" style="cursor: pointer; height: 280px; max-height: 480px; overflow: auto;
                                                                            ...
                                                                            <div id="div-gridview-2" class="whitebg">
                                                                                <asp:GridView ID="gridSubTypes" CssClass="datatable" CellPadding="0" runat="server"
                                                                    ...
                                                                    <div class="mid-inner">
                                                                        <div class="mid" style="cursor: pointer; height: 280px; max-height: 480px; overflow: auto;
                                                                            ...
                                                                            <div id="div-gridview-type" class="whitebg">
                                                                                <asp:GridView ID="gridItemTypes" CssClass="datatable" CellPadding="0" runat="server"
            ...
            <ContentTemplate>
                <asp:Panel ID="pnNotify" runat="server" Style="display: none; width: 460px; border: solid 1px #808080;z-index: 15000">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 18px">
                            <tr style="background-color: #479ADA;">
                                ...
                                <td style="width: 100%; height: 19px;">
                                    <span style="font-weight: bold; color: #F0F0F0">
                    ...
                    <table border="0" cellpadding="15" cellspacing="0" style="width: 100%;">
                        <tr>
                            <td style="width: 48px; background-color: #F0F0F0;" valign="middle" align="center">
                                <asp:Image ID="imgNotice" runat="server" ImageUrl="~/Images/mb_information.gif" Height="32px"
                                    Width="32px" />
                            </td>
                            <td style="width: 100%; background-color: #F0F0F0;" valign="middle" align="center">
