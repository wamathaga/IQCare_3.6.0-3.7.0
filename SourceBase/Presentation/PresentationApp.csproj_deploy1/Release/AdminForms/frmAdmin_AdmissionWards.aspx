                                        ...
                                        <div class="mid-inner">
                                            <div class="mid" style="cursor: pointer; height: 280px; max-height: 480px; overflow: auto;
                                                ...
                                                <div id="div-gridview" class="whitebg">
                                                    <asp:GridView ID="gridWardList" CssClass="datatable" CellPadding="0" runat="server"
        ...
        <asp:UpdatePanel ID="divDetailsCompnent" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <asp:Button ID="buttonRaiseItemPopup" runat="server" Style="display: none" />
                    ...
                    <asp:Panel ID="divData" runat="server" class="pad5 formbg border" Style="
                        z-index: 15000; overflow: auto;">
                        <div id="divWardList" class="grid">
                            <div class="mid-outer">
                                <div class="mid-inner">
                                    <div class="mid" style="cursor: pointer; height: 280px; max-height: 480px; overflow: auto;
                                        border: 1px solid #666699;">
                                        <div id="div-gridview">
                                            <asp:Panel ID="divTitle" runat="server" CssClass="datatable" Style="
                                            ...
                                            <table cellpadding="1" cellspacing="2" border="0" width="680px" class="whitebg" style="margin-bottom: 10px">
...
<%--                                                            <asp:ListItem Text="Peadiatric" Value="Peadiatric" />--%>
                                                ...
                                                <tr>
                                                    <td class="form pad5 center" style="white-space: nowrap; text-align: center" colspan="2">
