                                ...
                                <tr id="tblSaveButton">
                                    <td class="form" align="center">
                                        <asp:Button ID="btnsave" runat="server" OnClick="btnsave_Click" Text="Save" /><asp:Button
                                            ID="btncomplete" runat="server" OnClick="btncomplete_Click" Text="Data Quality Check"
                                            Visible="False" /><asp:Button ID="btnback" runat="server" OnClick="btnback_Click"
                                                Text="Close" /><asp:Button ID="btnPrint" runat="server" OnClick="btnPrint_Click"
                    ...
                    <ContentTemplate>
                        ...
                        <div class="border center formbg">
                            <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                    <td class="form" align="center">
                                        <asp:Button ID="btnCAsave" runat="server" Text="Save" OnClick="btnCAsave_Click" /><asp:Button
                                            ID="btnCAcomplete" runat="server" Text="Data Quality Check" OnClick="btncomplete_Click"
                                            Visible="False" /><asp:Button ID="btnCAback" runat="server" Text="Close" OnClick="btnCAback_Click" /><asp:Button
