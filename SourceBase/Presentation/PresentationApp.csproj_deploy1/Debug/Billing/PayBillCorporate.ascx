<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PayBillCorporate.ascx.cs" Inherits="IQCare.Web.Billing.PayBillCorporate" %>
...
<asp:UpdatePanel ID="notificationPanel" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <ajaxToolkit:ModalPopupExtender ID="notifyPopupExtender" runat="server" TargetControlID="btn"
            PopupControlID="pnNotify" BackgroundCssClass="modalBackground" DropShadow="True" BehaviorID="PYCPmpeBID01"
                ...
                <tr>
                    ...
                    <td align="center" width="25%" style="height: 100%">
                        <table width="100%" style="height: 100%">
                            <tr>
                                <td valign="middle">
                                    <asp:Button ID="buttonCompute" runat="server" Text="Validate" Height="70px"
