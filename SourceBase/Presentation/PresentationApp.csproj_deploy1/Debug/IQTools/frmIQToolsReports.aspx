        ...
        <div class="nomargin">
            <h2 class="nomargin">
                IQTools Reports &nbsp;&nbsp;&nbsp;&nbsp; <span>
                    <asp:Button ID="btrRefresh" runat="server" Text="Refresh Reports" 
                    OnClick="btrRefresh_Click" /></span>
            </h2>
        </div>
                                        ...
                                        <table cellpadding="2" cellspacing="0" border="0">
                                            <tr>
                                                ...
                                                <td valign="top" align="left">                                                    
                                                    <asp:Button ID="DocumentTemplateLink" runat="server" Visible="false"
                                                        CssClass="doclist" onclick="DocumentTemplateLink_Click" />                                                     
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" align="left" nowrap="nowrap">
                                                 <asp:Button ID="buttonReportXML" runat="server" Text="Get ReportXML" Width="160px" 
                                                    ...
                                                    <asp:Button ID="buttonClose" runat="server" Text="Close" Width="160px" 
