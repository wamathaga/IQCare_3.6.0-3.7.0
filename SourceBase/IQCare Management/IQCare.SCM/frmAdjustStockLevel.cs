...
namespace IQCare.SCM
{
    public partial class frmAdjustStockLevel : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                String AdjustmentDate = string.Format("{0:dd-MMM-yyyy}", dtpEffectiveDate.Text);
                int updateStock = chkUpdateStockFlag.Checked ? 1 : 0;
                ...
                int ret = objStock.SaveUpdateStockAdjustment(theDT, GblIQCare.AppLocationId, Convert.ToInt32(ddlStoreName.SelectedValue), AdjustmentDate, Convert.ToInt32(ddlPreparedBy.SelectedValue), Convert.ToInt32(ddlAuthoriseBy.SelectedValue), updateStock, GblIQCare.AppUserId);
                if (ret > 0)
                {
