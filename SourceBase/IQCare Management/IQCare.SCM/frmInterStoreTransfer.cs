    ...
    public partial class frmInterStoreTransfer : Form
    {
     ...
     //   bool IsHandleAdded;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //john start
                    if (ddlPreparedBy.SelectedValue != null)
                    {
                ...
                {
                    theDRow["PreparedBy"] = dsPOItemsDetail.Tables[0].Rows[0]["PreparedBy"].ToString();
                }
        ...
        private void BindGrid(DataSet theDS)
        {
            try
            {
                ...
                theColumnUnitQuantity.Visible = false;
