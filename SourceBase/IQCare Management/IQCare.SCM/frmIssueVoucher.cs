...
{
    public partial class frmIssueVoucher : Form
    {
        ...
        public void SetRights()
        {
            ...
            if (GblIQCare.HasFunctionRight(ApplicationAccess.IssueVoucher, FunctionAccess.Add, GblIQCare.dtUserRight) == false)
            {
        ...
        private void frmIssueVoucher_Load(object sender, EventArgs e)
        {
        ...
        private void BindGrid()
        {
            try
            {
                ...
                theColumnOrderQuantity.HeaderText = "Issued Quantity";
                ...
                else if (GblIQCare.ModePurchaseOrder == 2)
                {
                    ...
                    theColumnBatchName.HeaderText = "Batch number";
        ...
        private void BindGrnItemsGrid()
        {
            try
            {
                ...
                theColumnRecievedQuantity.HeaderText = "Issued Quantity";
                ...
                theColumnItemPurchasePrice.ReadOnly = true;
