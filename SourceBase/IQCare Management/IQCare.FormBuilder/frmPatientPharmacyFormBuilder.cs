...
{
    public partial class frmPatientPharmacyFormBuilder : Form
    {
        ...
        DataTable dtLnkFormsForManageField;
        ...
        public frmPatientPharmacyFormBuilder()
        {
            InitializeComponent();
        }

        private void frmPatientPharmacyFormBuilder_Load(object sender, EventArgs e)
        {
            //set css begin
            clsCssStyle theStyle = new clsCssStyle();
            theStyle.setStyle(this);
            txtFormName.Text = "Patient Pharmacy";
            ...
            else
            {
             ...
             IFieldDetail objFieldDetail;
                ...
                //3 is for Patient Pharmacy Field
        ...
        private void FillData()
        {
            ...
            if (dsUpdateMode.Tables[0].Rows.Count > 0)
            {
                ...
                //pass fieldName if want to retrieve specific field from GetCustomFields
                dsFieldDetails = objFieldDetail.GetCustomFields("", 0, 3);
                ///////////////////////////////////////
            }
            //mst section
            ...
            if (e.RowIndex != -1 && e.ColumnIndex != -1)
            {
                ...
                if (dgwGridData.Columns[e.ColumnIndex].Name == "Business Rule")
                {
                    ...
                    if (dgwGridData.Rows[e.RowIndex].Cells["Business Rule"].Value != null && dgwGridData.Rows[e.RowIndex].Cells["Business Rule"].Value.ToString() != "0" && dgwGridData.Rows[e.RowIndex].Cells["Business Rule"].Value.ToString() != "System.Drawing.Bitmap")
                    {
                        ...
                        Form theForm;
                        if (Convert.ToString(dt.Rows[0]["BusRuleID"]) == "28")
                        {
                            GblIQCare.iFieldId = Convert.ToInt32(dt.Rows[0]["FieldId"].ToString().Replace("8888", ""));
                            GblIQCare.blnCustomPharmacyPage = true;
        ...
        void btnRemoveField_Click(object sender, EventArgs e)
        {
            ...
            if (iSelectedFieldRowId > 0 && dgwRemoveSelectedRow.Index != -1)
            {
                ...
                if (dgwRemoveSelectedRow.Cells[8].Value.ToString() == "9999309")
                {
                    DialogResult msgconfirm = IQCareWindowMsgBox.ShowWindow(string.Format("By removing Regimen Line from the Pharmacy form you will not able to select ARV drugs.{0} Are you sure you want remove Regimen Line?", Environment.NewLine), "?", "", this);
        ...
        void theForm_Deactivate(object sender, EventArgs e)
        {
            ...
            frmPatientPharmacyFormBuilder_Load(sender, e);
        }
        ...
        private void btnManageSection_Click(object sender, EventArgs e)
        {
            ...
            //below line is commented by nidhi was unable to hold the section values in list control becoz we were not assigning list of section to datatable property of the page
        ...
        {
            if (Convert.ToString(cmbTechArea.SelectedValue) == "0")
            {
                IQCareWindowMsgBox.ShowWindow("PharmacyServiceArea", this);
                return;
            }
            string FlagPharmacyInsertUpdate="";
            ...
            DataRow row;
            int iFormId = 0;//iFormId = 72 is for Patient Pharmacy
            int iSectionId = 0;
            ...
            if (GblIQCare.iFormBuilderId != 0)
            {
                ...
                FlagPharmacyInsertUpdate= "U";
                row["FeatureId"] = iFormId;
                row["InsertUpdateStatus"] = "U";
            ...
            else
            {
                ...
                iFormId += 1;
                GblIQCare.iFormBuilderId = iFormId;
                row["InsertUpdateStatus"] = "I";
                row["FeatureName"] = txtFormName.Text.ToString().Trim() + "_" + cmbTechArea.Text;
            }
            row["ReportFlag"] = 0;
            row["DeleteFlag"] = 0;
            row["AdminFlag"] = 0;
            ...
            row["SystemId"] = 1;
            row["ModuleId"] = cmbTechArea.SelectedValue;
            row["MultiVisit"] = 0;
            ...
            if (blnSaveData)
            {
                ...
                objFormBuilder = (IFormBuilder)ObjectFactory.CreateInstance("BusinessProcess.FormBuilder.BFormBuilder,BusinessProcess.FormBuilder");
                DataTable dt = new DataTable();
                DataSet DSFormVer = new DataSet();
                int res = objFormBuilder.SaveFormDetail(dsCollectDataToSave, dsFieldDetails.Tables[0], dt, DSFormVer);
                GblIQCare.iFormBuilderId = 0;
